/**
 * PhasedLaserArraySpinalMountWeapon.js - Naval Weapon Battery Simulation: PhasedLaserArray mounted in SpinalMount.
 */

class PhasedLaserArraySpinalMountWeapon {
  constructor(firingMount = 'SpinalMount', options = {}) {
    this.weaponName = 'PhasedLaserArray';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 350;
    this.rateOfFireRpm = 12;
    this.muzzleVelocityKmS = 125;
    this.energyDrainMj = 45;
...
module.exports = { PhasedLaserArraySpinalMountWeapon };
