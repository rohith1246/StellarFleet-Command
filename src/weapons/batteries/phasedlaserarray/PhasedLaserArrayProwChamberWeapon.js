/**
 * PhasedLaserArrayProwChamberWeapon.js - Naval Weapon Battery Simulation: PhasedLaserArray mounted in ProwChamber.
 */

class PhasedLaserArrayProwChamberWeapon {
...
module.exports = { PhasedLaserArrayProwChamberWeapon };
