/**
 * PhasedLaserArrayVentralBatteryWeapon.js - Naval Weapon Battery Simulation: PhasedLaserArray mounted in VentralBattery.
 */

class PhasedLaserArrayVentralBatteryWeapon {
  constructor(firingMount = 'VentralBattery', options = {}) {
    this.weaponName = 'PhasedLaserArray';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 525;
    this.rateOfFireRpm = 18;
    this.muzzleVelocityKmS = 125;
    this.energyDrainMj = 66;
    this.heatGeneratedKj = 39;
    this.effectiveRangeKm = 2950;
...
module.exports = { PhasedLaserArrayVentralBatteryWeapon };
