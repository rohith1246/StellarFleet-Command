/**
 * PhasedLaserArraySalvoSiloWeapon.js - Naval Weapon Battery Simulation: PhasedLaserArray mounted in SalvoSilo.
 */

class PhasedLaserArraySalvoSiloWeapon {
...
module.exports = { PhasedLaserArraySalvoSiloWeapon };
