/**
 * PhasedLaserArrayDorsalHardpointWeapon.js - Naval Weapon Battery Simulation: PhasedLaserArray mounted in DorsalHardpoint.
 */

class PhasedLaserArrayDorsalHardpointWeapon {
  constructor(firingMount = 'DorsalHardpoint', options = {}) {
    this.weaponName = 'PhasedLaserArray';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 500;
...
module.exports = { PhasedLaserArrayDorsalHardpointWeapon };
