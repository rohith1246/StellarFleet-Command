/**
 * PhasedLaserArrayPointDefenseGimbalWeapon.js - Naval Weapon Battery Simulation: PhasedLaserArray mounted in PointDefenseGimbal.
 */

class PhasedLaserArrayPointDefenseGimbalWeapon {
  constructor(firingMount = 'PointDefenseGimbal', options = {}) {
    this.weaponName = 'PhasedLaserArray';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 450;
    this.rateOfFireRpm = 36;
    this.muzzleVelocityKmS = 125;
    this.energyDrainMj = 57;
...
module.exports = { PhasedLaserArrayPointDefenseGimbalWeapon };
