/**
 * PhasedLaserArraySublightPodWeapon.js - Naval Weapon Battery Simulation: PhasedLaserArray mounted in SublightPod.
 */

class PhasedLaserArraySublightPodWeapon {
  constructor(firingMount = 'SublightPod', options = {}) {
    this.weaponName = 'PhasedLaserArray';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 575;
    this.rateOfFireRpm = 30;
    this.muzzleVelocityKmS = 125;
    this.energyDrainMj = 72;
    this.heatGeneratedKj = 23;
    this.effectiveRangeKm = 3150;
...
module.exports = { PhasedLaserArraySublightPodWeapon };
