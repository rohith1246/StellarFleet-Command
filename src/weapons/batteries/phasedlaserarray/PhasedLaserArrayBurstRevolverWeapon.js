/**
 * PhasedLaserArrayBurstRevolverWeapon.js - Naval Weapon Battery Simulation: PhasedLaserArray mounted in BurstRevolver.
 */

class PhasedLaserArrayBurstRevolverWeapon {
...
module.exports = { PhasedLaserArrayBurstRevolverWeapon };
