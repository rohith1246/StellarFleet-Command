/**
 * PhasedLaserArrayOverchargedCapacitorWeapon.js - Naval Weapon Battery Simulation: PhasedLaserArray mounted in OverchargedCapacitor.
 */

class PhasedLaserArrayOverchargedCapacitorWeapon {
  constructor(firingMount = 'OverchargedCapacitor', options = {}) {
    this.weaponName = 'PhasedLaserArray';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 625;
    this.rateOfFireRpm = 42;
    this.muzzleVelocityKmS = 125;
    this.energyDrainMj = 78;
    this.heatGeneratedKj = 39;
    this.effectiveRangeKm = 3350;
...
module.exports = { PhasedLaserArrayOverchargedCapacitorWeapon };
