/**
 * PhasedLaserArrayTurretDualWeapon.js - Naval Weapon Battery Simulation: PhasedLaserArray mounted in TurretDual.
 */

class PhasedLaserArrayTurretDualWeapon {
...
module.exports = { PhasedLaserArrayTurretDualWeapon };
