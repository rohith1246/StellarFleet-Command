/**
 * PhasedLaserArrayBroadsideArrayWeapon.js - Naval Weapon Battery Simulation: PhasedLaserArray mounted in BroadsideArray.
 */

class PhasedLaserArrayBroadsideArrayWeapon {
...
module.exports = { PhasedLaserArrayBroadsideArrayWeapon };
