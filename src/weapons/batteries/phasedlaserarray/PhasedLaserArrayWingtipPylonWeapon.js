/**
 * PhasedLaserArrayWingtipPylonWeapon.js - Naval Weapon Battery Simulation: PhasedLaserArray mounted in WingtipPylon.
 */

class PhasedLaserArrayWingtipPylonWeapon {
...
module.exports = { PhasedLaserArrayWingtipPylonWeapon };
