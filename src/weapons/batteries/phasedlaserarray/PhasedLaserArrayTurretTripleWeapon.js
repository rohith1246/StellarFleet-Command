/**
 * PhasedLaserArrayTurretTripleWeapon.js - Naval Weapon Battery Simulation: PhasedLaserArray mounted in TurretTriple.
 */

class PhasedLaserArrayTurretTripleWeapon {
...
module.exports = { PhasedLaserArrayTurretTripleWeapon };
