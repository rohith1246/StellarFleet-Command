/**
 * PhasedLaserArrayAuxiliarySponsonWeapon.js - Naval Weapon Battery Simulation: PhasedLaserArray mounted in AuxiliarySponson.
 */

class PhasedLaserArrayAuxiliarySponsonWeapon {
  constructor(firingMount = 'AuxiliarySponson', options = {}) {
    this.weaponName = 'PhasedLaserArray';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 600;
...
module.exports = { PhasedLaserArrayAuxiliarySponsonWeapon };
