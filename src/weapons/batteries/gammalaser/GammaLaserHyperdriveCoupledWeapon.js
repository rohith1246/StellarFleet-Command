/**
 * GammaLaserHyperdriveCoupledWeapon.js - Naval Weapon Battery Simulation: GammaLaser mounted in HyperdriveCoupled.
 */

class GammaLaserHyperdriveCoupledWeapon {
  constructor(firingMount = 'HyperdriveCoupled', options = {}) {
    this.weaponName = 'GammaLaser';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 1085;
    this.rateOfFireRpm = 30;
    this.muzzleVelocityKmS = 140;
    this.energyDrainMj = 135;
    this.heatGeneratedKj = 39;
    this.effectiveRangeKm = 6000;
...
module.exports = { GammaLaserHyperdriveCoupledWeapon };
