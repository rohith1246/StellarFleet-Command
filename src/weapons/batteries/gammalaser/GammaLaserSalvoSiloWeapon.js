/**
 * GammaLaserSalvoSiloWeapon.js - Naval Weapon Battery Simulation: GammaLaser mounted in SalvoSilo.
 */

class GammaLaserSalvoSiloWeapon {
  constructor(firingMount = 'SalvoSilo', options = {}) {
    this.weaponName = 'GammaLaser';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 1060;
    this.rateOfFireRpm = 24;
    this.muzzleVelocityKmS = 140;
    this.energyDrainMj = 132;
    this.heatGeneratedKj = 31;
    this.effectiveRangeKm = 5900;
...
module.exports = { GammaLaserSalvoSiloWeapon };
