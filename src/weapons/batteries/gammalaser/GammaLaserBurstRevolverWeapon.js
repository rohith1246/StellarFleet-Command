/**
 * GammaLaserBurstRevolverWeapon.js - Naval Weapon Battery Simulation: GammaLaser mounted in BurstRevolver.
 */

class GammaLaserBurstRevolverWeapon {
  constructor(firingMount = 'BurstRevolver', options = {}) {
    this.weaponName = 'GammaLaser';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 1010;
    this.rateOfFireRpm = 12;
    this.muzzleVelocityKmS = 140;
    this.energyDrainMj = 126;
    this.heatGeneratedKj = 15;
    this.effectiveRangeKm = 5700;
...
module.exports = { GammaLaserBurstRevolverWeapon };
