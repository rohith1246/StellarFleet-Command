/**
 * GammaLaserOverchargedCapacitorWeapon.js - Naval Weapon Battery Simulation: GammaLaser mounted in OverchargedCapacitor.
 */

class GammaLaserOverchargedCapacitorWeapon {
  constructor(firingMount = 'OverchargedCapacitor', options = {}) {
    this.weaponName = 'GammaLaser';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 985;
    this.rateOfFireRpm = 42;
    this.muzzleVelocityKmS = 140;
    this.energyDrainMj = 123;
    this.heatGeneratedKj = 39;
    this.effectiveRangeKm = 5600;
...
module.exports = { GammaLaserOverchargedCapacitorWeapon };
