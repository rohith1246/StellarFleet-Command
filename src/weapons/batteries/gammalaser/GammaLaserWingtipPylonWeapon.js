/**
 * GammaLaserWingtipPylonWeapon.js - Naval Weapon Battery Simulation: GammaLaser mounted in WingtipPylon.
 */

class GammaLaserWingtipPylonWeapon {
  constructor(firingMount = 'WingtipPylon', options = {}) {
    this.weaponName = 'GammaLaser';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 910;
...
module.exports = { GammaLaserWingtipPylonWeapon };
