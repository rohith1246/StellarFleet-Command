/**
 * GammaLaserTurretDualWeapon.js - Naval Weapon Battery Simulation: GammaLaser mounted in TurretDual.
 */

class GammaLaserTurretDualWeapon {
  constructor(firingMount = 'TurretDual', options = {}) {
    this.weaponName = 'GammaLaser';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 735;
...
module.exports = { GammaLaserTurretDualWeapon };
