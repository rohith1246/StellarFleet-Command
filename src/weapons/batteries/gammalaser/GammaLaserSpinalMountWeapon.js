/**
 * GammaLaserSpinalMountWeapon.js - Naval Weapon Battery Simulation: GammaLaser mounted in SpinalMount.
 */

class GammaLaserSpinalMountWeapon {
  constructor(firingMount = 'SpinalMount', options = {}) {
    this.weaponName = 'GammaLaser';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 710;
...
module.exports = { GammaLaserSpinalMountWeapon };
