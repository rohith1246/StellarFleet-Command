/**
 * GammaLaserContinuousBeamMountWeapon.js - Naval Weapon Battery Simulation: GammaLaser mounted in ContinuousBeamMount.
 */

class GammaLaserContinuousBeamMountWeapon {
  constructor(firingMount = 'ContinuousBeamMount', options = {}) {
    this.weaponName = 'GammaLaser';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 1035;
    this.rateOfFireRpm = 18;
    this.muzzleVelocityKmS = 140;
    this.energyDrainMj = 129;
    this.heatGeneratedKj = 23;
    this.effectiveRangeKm = 5800;
...
module.exports = { GammaLaserContinuousBeamMountWeapon };
