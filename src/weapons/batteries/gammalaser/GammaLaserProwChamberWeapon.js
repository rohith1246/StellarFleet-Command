/**
 * GammaLaserProwChamberWeapon.js - Naval Weapon Battery Simulation: GammaLaser mounted in ProwChamber.
 */

class GammaLaserProwChamberWeapon {
...
module.exports = { GammaLaserProwChamberWeapon };
