/**
 * GammaLaserAuxiliarySponsonWeapon.js - Naval Weapon Battery Simulation: GammaLaser mounted in AuxiliarySponson.
 */

class GammaLaserAuxiliarySponsonWeapon {
  constructor(firingMount = 'AuxiliarySponson', options = {}) {
    this.weaponName = 'GammaLaser';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 960;
    this.rateOfFireRpm = 36;
    this.muzzleVelocityKmS = 140;
    this.energyDrainMj = 120;
    this.heatGeneratedKj = 31;
    this.effectiveRangeKm = 5500;
...
module.exports = { GammaLaserAuxiliarySponsonWeapon };
