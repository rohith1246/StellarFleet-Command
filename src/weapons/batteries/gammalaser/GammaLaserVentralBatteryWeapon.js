/**
 * GammaLaserVentralBatteryWeapon.js - Naval Weapon Battery Simulation: GammaLaser mounted in VentralBattery.
 */

class GammaLaserVentralBatteryWeapon {
...
module.exports = { GammaLaserVentralBatteryWeapon };
