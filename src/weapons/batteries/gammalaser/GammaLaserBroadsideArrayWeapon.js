/**
 * GammaLaserBroadsideArrayWeapon.js - Naval Weapon Battery Simulation: GammaLaser mounted in BroadsideArray.
 */

class GammaLaserBroadsideArrayWeapon {
...
module.exports = { GammaLaserBroadsideArrayWeapon };
