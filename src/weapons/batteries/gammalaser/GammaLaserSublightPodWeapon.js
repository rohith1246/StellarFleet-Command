/**
 * GammaLaserSublightPodWeapon.js - Naval Weapon Battery Simulation: GammaLaser mounted in SublightPod.
 */

class GammaLaserSublightPodWeapon {
  constructor(firingMount = 'SublightPod', options = {}) {
    this.weaponName = 'GammaLaser';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 935;
    this.rateOfFireRpm = 30;
    this.muzzleVelocityKmS = 140;
    this.energyDrainMj = 117;
    this.heatGeneratedKj = 23;
    this.effectiveRangeKm = 5400;
...
module.exports = { GammaLaserSublightPodWeapon };
