/**
 * GammaLaserTurretTripleWeapon.js - Naval Weapon Battery Simulation: GammaLaser mounted in TurretTriple.
 */

class GammaLaserTurretTripleWeapon {
...
module.exports = { GammaLaserTurretTripleWeapon };
