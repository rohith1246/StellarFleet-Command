/**
 * GammaLaserPointDefenseGimbalWeapon.js - Naval Weapon Battery Simulation: GammaLaser mounted in PointDefenseGimbal.
 */

class GammaLaserPointDefenseGimbalWeapon {
  constructor(firingMount = 'PointDefenseGimbal', options = {}) {
    this.weaponName = 'GammaLaser';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 810;
    this.rateOfFireRpm = 36;
    this.muzzleVelocityKmS = 140;
    this.energyDrainMj = 102;
    this.heatGeneratedKj = 15;
    this.effectiveRangeKm = 4900;
...
module.exports = { GammaLaserPointDefenseGimbalWeapon };
