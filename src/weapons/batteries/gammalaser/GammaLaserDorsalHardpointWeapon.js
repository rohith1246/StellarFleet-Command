/**
 * GammaLaserDorsalHardpointWeapon.js - Naval Weapon Battery Simulation: GammaLaser mounted in DorsalHardpoint.
 */

class GammaLaserDorsalHardpointWeapon {
  constructor(firingMount = 'DorsalHardpoint', options = {}) {
    this.weaponName = 'GammaLaser';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 860;
...
module.exports = { GammaLaserDorsalHardpointWeapon };
