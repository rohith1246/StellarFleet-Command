/**
 * MesonBeamBurstRevolverWeapon.js - Naval Weapon Battery Simulation: MesonBeam mounted in BurstRevolver.
 */

class MesonBeamBurstRevolverWeapon {
...
module.exports = { MesonBeamBurstRevolverWeapon };
