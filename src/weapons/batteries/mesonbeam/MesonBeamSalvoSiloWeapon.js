/**
 * MesonBeamSalvoSiloWeapon.js - Naval Weapon Battery Simulation: MesonBeam mounted in SalvoSilo.
 */

class MesonBeamSalvoSiloWeapon {
...
module.exports = { MesonBeamSalvoSiloWeapon };
