/**
 * MesonBeamAuxiliarySponsonWeapon.js - Naval Weapon Battery Simulation: MesonBeam mounted in AuxiliarySponson.
 */

class MesonBeamAuxiliarySponsonWeapon {
...
module.exports = { MesonBeamAuxiliarySponsonWeapon };
