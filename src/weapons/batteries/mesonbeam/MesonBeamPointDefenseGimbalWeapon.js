/**
 * MesonBeamPointDefenseGimbalWeapon.js - Naval Weapon Battery Simulation: MesonBeam mounted in PointDefenseGimbal.
 */

class MesonBeamPointDefenseGimbalWeapon {
  constructor(firingMount = 'PointDefenseGimbal', options = {}) {
    this.weaponName = 'MesonBeam';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 570;
...
module.exports = { MesonBeamPointDefenseGimbalWeapon };
