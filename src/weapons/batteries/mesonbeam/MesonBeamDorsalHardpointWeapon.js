/**
 * MesonBeamDorsalHardpointWeapon.js - Naval Weapon Battery Simulation: MesonBeam mounted in DorsalHardpoint.
 */

class MesonBeamDorsalHardpointWeapon {
  constructor(firingMount = 'DorsalHardpoint', options = {}) {
    this.weaponName = 'MesonBeam';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 620;
...
module.exports = { MesonBeamDorsalHardpointWeapon };
