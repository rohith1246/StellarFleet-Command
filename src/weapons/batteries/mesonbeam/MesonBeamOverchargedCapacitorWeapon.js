/**
 * MesonBeamOverchargedCapacitorWeapon.js - Naval Weapon Battery Simulation: MesonBeam mounted in OverchargedCapacitor.
 */

class MesonBeamOverchargedCapacitorWeapon {
  constructor(firingMount = 'OverchargedCapacitor', options = {}) {
    this.weaponName = 'MesonBeam';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 745;
    this.rateOfFireRpm = 42;
    this.muzzleVelocityKmS = 50;
    this.energyDrainMj = 93;
    this.heatGeneratedKj = 39;
    this.effectiveRangeKm = 4100;
...
module.exports = { MesonBeamOverchargedCapacitorWeapon };
