/**
 * MesonBeamWingtipPylonWeapon.js - Naval Weapon Battery Simulation: MesonBeam mounted in WingtipPylon.
 */

class MesonBeamWingtipPylonWeapon {
  constructor(firingMount = 'WingtipPylon', options = {}) {
    this.weaponName = 'MesonBeam';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 670;
...
module.exports = { MesonBeamWingtipPylonWeapon };
