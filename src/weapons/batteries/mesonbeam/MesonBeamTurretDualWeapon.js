/**
 * MesonBeamTurretDualWeapon.js - Naval Weapon Battery Simulation: MesonBeam mounted in TurretDual.
 */

class MesonBeamTurretDualWeapon {
...
module.exports = { MesonBeamTurretDualWeapon };
