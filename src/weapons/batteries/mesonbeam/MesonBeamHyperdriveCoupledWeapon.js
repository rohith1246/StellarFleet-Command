/**
 * MesonBeamHyperdriveCoupledWeapon.js - Naval Weapon Battery Simulation: MesonBeam mounted in HyperdriveCoupled.
 */

class MesonBeamHyperdriveCoupledWeapon {
  constructor(firingMount = 'HyperdriveCoupled', options = {}) {
    this.weaponName = 'MesonBeam';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 845;
...
module.exports = { MesonBeamHyperdriveCoupledWeapon };
