/**
 * MesonBeamVentralBatteryWeapon.js - Naval Weapon Battery Simulation: MesonBeam mounted in VentralBattery.
 */

class MesonBeamVentralBatteryWeapon {
...
module.exports = { MesonBeamVentralBatteryWeapon };
