/**
 * MesonBeamSpinalMountWeapon.js - Naval Weapon Battery Simulation: MesonBeam mounted in SpinalMount.
 */

class MesonBeamSpinalMountWeapon {
  constructor(firingMount = 'SpinalMount', options = {}) {
    this.weaponName = 'MesonBeam';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 470;
    this.rateOfFireRpm = 12;
    this.muzzleVelocityKmS = 50;
    this.energyDrainMj = 60;
    this.heatGeneratedKj = 15;
    this.effectiveRangeKm = 3000;
...
module.exports = { MesonBeamSpinalMountWeapon };
