/**
 * MesonBeamProwChamberWeapon.js - Naval Weapon Battery Simulation: MesonBeam mounted in ProwChamber.
 */

class MesonBeamProwChamberWeapon {
...
module.exports = { MesonBeamProwChamberWeapon };
