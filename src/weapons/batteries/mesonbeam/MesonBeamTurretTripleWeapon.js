/**
 * MesonBeamTurretTripleWeapon.js - Naval Weapon Battery Simulation: MesonBeam mounted in TurretTriple.
 */

class MesonBeamTurretTripleWeapon {
...
module.exports = { MesonBeamTurretTripleWeapon };
