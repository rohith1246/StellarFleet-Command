/**
 * MesonBeamBroadsideArrayWeapon.js - Naval Weapon Battery Simulation: MesonBeam mounted in BroadsideArray.
 */

class MesonBeamBroadsideArrayWeapon {
...
module.exports = { MesonBeamBroadsideArrayWeapon };
