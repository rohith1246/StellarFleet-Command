/**
 * MesonBeamContinuousBeamMountWeapon.js - Naval Weapon Battery Simulation: MesonBeam mounted in ContinuousBeamMount.
 */

class MesonBeamContinuousBeamMountWeapon {
  constructor(firingMount = 'ContinuousBeamMount', options = {}) {
    this.weaponName = 'MesonBeam';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 795;
    this.rateOfFireRpm = 18;
    this.muzzleVelocityKmS = 50;
    this.energyDrainMj = 99;
    this.heatGeneratedKj = 23;
    this.effectiveRangeKm = 4300;
...
module.exports = { MesonBeamContinuousBeamMountWeapon };
