/**
 * AntimatterTorpedoTurretDualWeapon.js - Naval Weapon Battery Simulation: AntimatterTorpedo mounted in TurretDual.
 */

class AntimatterTorpedoTurretDualWeapon {
  constructor(firingMount = 'TurretDual', options = {}) {
    this.weaponName = 'AntimatterTorpedo';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 295;
    this.rateOfFireRpm = 18;
    this.muzzleVelocityKmS = 95;
    this.energyDrainMj = 38;
...
module.exports = { AntimatterTorpedoTurretDualWeapon };
