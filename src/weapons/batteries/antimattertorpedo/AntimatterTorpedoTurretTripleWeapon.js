/**
 * AntimatterTorpedoTurretTripleWeapon.js - Naval Weapon Battery Simulation: AntimatterTorpedo mounted in TurretTriple.
 */

class AntimatterTorpedoTurretTripleWeapon {
  constructor(firingMount = 'TurretTriple', options = {}) {
    this.weaponName = 'AntimatterTorpedo';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 320;
    this.rateOfFireRpm = 24;
    this.muzzleVelocityKmS = 95;
    this.energyDrainMj = 41;
...
module.exports = { AntimatterTorpedoTurretTripleWeapon };
