/**
 * AntimatterTorpedoSalvoSiloWeapon.js - Naval Weapon Battery Simulation: AntimatterTorpedo mounted in SalvoSilo.
 */

class AntimatterTorpedoSalvoSiloWeapon {
...
module.exports = { AntimatterTorpedoSalvoSiloWeapon };
