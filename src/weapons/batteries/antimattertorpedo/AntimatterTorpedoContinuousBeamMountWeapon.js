/**
 * AntimatterTorpedoContinuousBeamMountWeapon.js - Naval Weapon Battery Simulation: AntimatterTorpedo mounted in ContinuousBeamMount.
 */

class AntimatterTorpedoContinuousBeamMountWeapon {
  constructor(firingMount = 'ContinuousBeamMount', options = {}) {
    this.weaponName = 'AntimatterTorpedo';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 595;
    this.rateOfFireRpm = 18;
    this.muzzleVelocityKmS = 95;
    this.energyDrainMj = 74;
...
module.exports = { AntimatterTorpedoContinuousBeamMountWeapon };
