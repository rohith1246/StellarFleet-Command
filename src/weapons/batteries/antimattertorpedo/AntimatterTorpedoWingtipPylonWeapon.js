/**
 * AntimatterTorpedoWingtipPylonWeapon.js - Naval Weapon Battery Simulation: AntimatterTorpedo mounted in WingtipPylon.
 */

class AntimatterTorpedoWingtipPylonWeapon {
...
module.exports = { AntimatterTorpedoWingtipPylonWeapon };
