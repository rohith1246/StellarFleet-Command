/**
 * AntimatterTorpedoProwChamberWeapon.js - Naval Weapon Battery Simulation: AntimatterTorpedo mounted in ProwChamber.
 */

class AntimatterTorpedoProwChamberWeapon {
  constructor(firingMount = 'ProwChamber', options = {}) {
    this.weaponName = 'AntimatterTorpedo';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 395;
...
module.exports = { AntimatterTorpedoProwChamberWeapon };
