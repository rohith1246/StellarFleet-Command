/**
 * AntimatterTorpedoOverchargedCapacitorWeapon.js - Naval Weapon Battery Simulation: AntimatterTorpedo mounted in OverchargedCapacitor.
 */

class AntimatterTorpedoOverchargedCapacitorWeapon {
  constructor(firingMount = 'OverchargedCapacitor', options = {}) {
    this.weaponName = 'AntimatterTorpedo';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 545;
    this.rateOfFireRpm = 42;
    this.muzzleVelocityKmS = 95;
    this.energyDrainMj = 68;
    this.heatGeneratedKj = 39;
    this.effectiveRangeKm = 2850;
...
module.exports = { AntimatterTorpedoOverchargedCapacitorWeapon };
