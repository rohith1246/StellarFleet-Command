/**
 * AntimatterTorpedoVentralBatteryWeapon.js - Naval Weapon Battery Simulation: AntimatterTorpedo mounted in VentralBattery.
 */

class AntimatterTorpedoVentralBatteryWeapon {
  constructor(firingMount = 'VentralBattery', options = {}) {
    this.weaponName = 'AntimatterTorpedo';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 445;
    this.rateOfFireRpm = 18;
    this.muzzleVelocityKmS = 95;
    this.energyDrainMj = 56;
...
module.exports = { AntimatterTorpedoVentralBatteryWeapon };
