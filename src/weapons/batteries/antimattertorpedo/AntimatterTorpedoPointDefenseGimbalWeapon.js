/**
 * AntimatterTorpedoPointDefenseGimbalWeapon.js - Naval Weapon Battery Simulation: AntimatterTorpedo mounted in PointDefenseGimbal.
 */

class AntimatterTorpedoPointDefenseGimbalWeapon {
  constructor(firingMount = 'PointDefenseGimbal', options = {}) {
    this.weaponName = 'AntimatterTorpedo';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 370;
...
module.exports = { AntimatterTorpedoPointDefenseGimbalWeapon };
