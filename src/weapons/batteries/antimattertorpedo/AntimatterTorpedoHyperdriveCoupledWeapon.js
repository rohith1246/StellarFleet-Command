/**
 * AntimatterTorpedoHyperdriveCoupledWeapon.js - Naval Weapon Battery Simulation: AntimatterTorpedo mounted in HyperdriveCoupled.
 */

class AntimatterTorpedoHyperdriveCoupledWeapon {
  constructor(firingMount = 'HyperdriveCoupled', options = {}) {
    this.weaponName = 'AntimatterTorpedo';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 645;
    this.rateOfFireRpm = 30;
    this.muzzleVelocityKmS = 95;
    this.energyDrainMj = 80;
    this.heatGeneratedKj = 39;
    this.effectiveRangeKm = 3250;
...
module.exports = { AntimatterTorpedoHyperdriveCoupledWeapon };
