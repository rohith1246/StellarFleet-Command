/**
 * AntimatterTorpedoSublightPodWeapon.js - Naval Weapon Battery Simulation: AntimatterTorpedo mounted in SublightPod.
 */

class AntimatterTorpedoSublightPodWeapon {
  constructor(firingMount = 'SublightPod', options = {}) {
    this.weaponName = 'AntimatterTorpedo';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 495;
    this.rateOfFireRpm = 30;
    this.muzzleVelocityKmS = 95;
    this.energyDrainMj = 62;
    this.heatGeneratedKj = 23;
    this.effectiveRangeKm = 2650;
...
module.exports = { AntimatterTorpedoSublightPodWeapon };
