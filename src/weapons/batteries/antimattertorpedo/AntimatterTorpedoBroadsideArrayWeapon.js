/**
 * AntimatterTorpedoBroadsideArrayWeapon.js - Naval Weapon Battery Simulation: AntimatterTorpedo mounted in BroadsideArray.
 */

class AntimatterTorpedoBroadsideArrayWeapon {
  constructor(firingMount = 'BroadsideArray', options = {}) {
    this.weaponName = 'AntimatterTorpedo';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 345;
    this.rateOfFireRpm = 30;
    this.muzzleVelocityKmS = 95;
    this.energyDrainMj = 44;
...
module.exports = { AntimatterTorpedoBroadsideArrayWeapon };
