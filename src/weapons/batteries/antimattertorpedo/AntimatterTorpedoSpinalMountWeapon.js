/**
 * AntimatterTorpedoSpinalMountWeapon.js - Naval Weapon Battery Simulation: AntimatterTorpedo mounted in SpinalMount.
 */

class AntimatterTorpedoSpinalMountWeapon {
  constructor(firingMount = 'SpinalMount', options = {}) {
    this.weaponName = 'AntimatterTorpedo';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 270;
    this.rateOfFireRpm = 12;
    this.muzzleVelocityKmS = 95;
    this.energyDrainMj = 35;
    this.heatGeneratedKj = 15;
    this.effectiveRangeKm = 1750;
...
module.exports = { AntimatterTorpedoSpinalMountWeapon };
