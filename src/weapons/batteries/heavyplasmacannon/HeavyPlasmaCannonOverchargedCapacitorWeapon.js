/**
 * HeavyPlasmaCannonOverchargedCapacitorWeapon.js - Naval Weapon Battery Simulation: HeavyPlasmaCannon mounted in OverchargedCapacitor.
 */

class HeavyPlasmaCannonOverchargedCapacitorWeapon {
  constructor(firingMount = 'OverchargedCapacitor', options = {}) {
    this.weaponName = 'HeavyPlasmaCannon';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 465;
    this.rateOfFireRpm = 42;
    this.muzzleVelocityKmS = 65;
    this.energyDrainMj = 58;
    this.heatGeneratedKj = 39;
    this.effectiveRangeKm = 2350;
...
module.exports = { HeavyPlasmaCannonOverchargedCapacitorWeapon };
