/**
 * HeavyPlasmaCannonContinuousBeamMountWeapon.js - Naval Weapon Battery Simulation: HeavyPlasmaCannon mounted in ContinuousBeamMount.
 */

class HeavyPlasmaCannonContinuousBeamMountWeapon {
  constructor(firingMount = 'ContinuousBeamMount', options = {}) {
    this.weaponName = 'HeavyPlasmaCannon';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 515;
    this.rateOfFireRpm = 18;
    this.muzzleVelocityKmS = 65;
    this.energyDrainMj = 64;
    this.heatGeneratedKj = 23;
    this.effectiveRangeKm = 2550;
...
module.exports = { HeavyPlasmaCannonContinuousBeamMountWeapon };
