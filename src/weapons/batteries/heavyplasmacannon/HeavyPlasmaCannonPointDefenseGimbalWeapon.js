/**
 * HeavyPlasmaCannonPointDefenseGimbalWeapon.js - Naval Weapon Battery Simulation: HeavyPlasmaCannon mounted in PointDefenseGimbal.
 */

class HeavyPlasmaCannonPointDefenseGimbalWeapon {
  constructor(firingMount = 'PointDefenseGimbal', options = {}) {
    this.weaponName = 'HeavyPlasmaCannon';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 290;
    this.rateOfFireRpm = 36;
    this.muzzleVelocityKmS = 65;
    this.energyDrainMj = 37;
    this.heatGeneratedKj = 15;
    this.effectiveRangeKm = 1650;
...
module.exports = { HeavyPlasmaCannonPointDefenseGimbalWeapon };
