/**
 * HeavyPlasmaCannonSpinalMountWeapon.js - Naval Weapon Battery Simulation: HeavyPlasmaCannon mounted in SpinalMount.
 */

class HeavyPlasmaCannonSpinalMountWeapon {
  constructor(firingMount = 'SpinalMount', options = {}) {
    this.weaponName = 'HeavyPlasmaCannon';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 190;
    this.rateOfFireRpm = 12;
    this.muzzleVelocityKmS = 65;
    this.energyDrainMj = 25;
    this.heatGeneratedKj = 15;
    this.effectiveRangeKm = 1250;
...
module.exports = { HeavyPlasmaCannonSpinalMountWeapon };
