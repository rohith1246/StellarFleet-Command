/**
 * HeavyPlasmaCannonHyperdriveCoupledWeapon.js - Naval Weapon Battery Simulation: HeavyPlasmaCannon mounted in HyperdriveCoupled.
 */

class HeavyPlasmaCannonHyperdriveCoupledWeapon {
  constructor(firingMount = 'HyperdriveCoupled', options = {}) {
    this.weaponName = 'HeavyPlasmaCannon';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 565;
...
module.exports = { HeavyPlasmaCannonHyperdriveCoupledWeapon };
