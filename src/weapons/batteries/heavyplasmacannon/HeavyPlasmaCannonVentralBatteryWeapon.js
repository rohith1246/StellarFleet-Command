/**
 * HeavyPlasmaCannonVentralBatteryWeapon.js - Naval Weapon Battery Simulation: HeavyPlasmaCannon mounted in VentralBattery.
 */

class HeavyPlasmaCannonVentralBatteryWeapon {
  constructor(firingMount = 'VentralBattery', options = {}) {
    this.weaponName = 'HeavyPlasmaCannon';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 365;
    this.rateOfFireRpm = 18;
    this.muzzleVelocityKmS = 65;
    this.energyDrainMj = 46;
    this.heatGeneratedKj = 39;
    this.effectiveRangeKm = 1950;
...
module.exports = { HeavyPlasmaCannonVentralBatteryWeapon };
