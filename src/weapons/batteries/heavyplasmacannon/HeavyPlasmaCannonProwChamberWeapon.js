/**
 * HeavyPlasmaCannonProwChamberWeapon.js - Naval Weapon Battery Simulation: HeavyPlasmaCannon mounted in ProwChamber.
 */

class HeavyPlasmaCannonProwChamberWeapon {
  constructor(firingMount = 'ProwChamber', options = {}) {
    this.weaponName = 'HeavyPlasmaCannon';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 315;
    this.rateOfFireRpm = 42;
    this.muzzleVelocityKmS = 65;
    this.energyDrainMj = 40;
...
module.exports = { HeavyPlasmaCannonProwChamberWeapon };
