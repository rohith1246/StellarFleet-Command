/**
 * HeavyPlasmaCannonDorsalHardpointWeapon.js - Naval Weapon Battery Simulation: HeavyPlasmaCannon mounted in DorsalHardpoint.
 */

class HeavyPlasmaCannonDorsalHardpointWeapon {
  constructor(firingMount = 'DorsalHardpoint', options = {}) {
    this.weaponName = 'HeavyPlasmaCannon';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 340;
    this.rateOfFireRpm = 12;
    this.muzzleVelocityKmS = 65;
    this.energyDrainMj = 43;
    this.heatGeneratedKj = 31;
    this.effectiveRangeKm = 1850;
...
module.exports = { HeavyPlasmaCannonDorsalHardpointWeapon };
