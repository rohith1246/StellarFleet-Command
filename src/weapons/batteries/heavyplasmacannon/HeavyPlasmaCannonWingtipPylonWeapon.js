/**
 * HeavyPlasmaCannonWingtipPylonWeapon.js - Naval Weapon Battery Simulation: HeavyPlasmaCannon mounted in WingtipPylon.
 */

class HeavyPlasmaCannonWingtipPylonWeapon {
  constructor(firingMount = 'WingtipPylon', options = {}) {
    this.weaponName = 'HeavyPlasmaCannon';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 390;
    this.rateOfFireRpm = 24;
    this.muzzleVelocityKmS = 65;
    this.energyDrainMj = 49;
    this.heatGeneratedKj = 15;
    this.effectiveRangeKm = 2050;
...
module.exports = { HeavyPlasmaCannonWingtipPylonWeapon };
