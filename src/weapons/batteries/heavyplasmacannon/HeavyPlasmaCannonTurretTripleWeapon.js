/**
 * HeavyPlasmaCannonTurretTripleWeapon.js - Naval Weapon Battery Simulation: HeavyPlasmaCannon mounted in TurretTriple.
 */

class HeavyPlasmaCannonTurretTripleWeapon {
  constructor(firingMount = 'TurretTriple', options = {}) {
    this.weaponName = 'HeavyPlasmaCannon';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 240;
    this.rateOfFireRpm = 24;
    this.muzzleVelocityKmS = 65;
    this.energyDrainMj = 31;
    this.heatGeneratedKj = 31;
    this.effectiveRangeKm = 1450;
...
module.exports = { HeavyPlasmaCannonTurretTripleWeapon };
