/**
 * HeavyPlasmaCannonTurretDualWeapon.js - Naval Weapon Battery Simulation: HeavyPlasmaCannon mounted in TurretDual.
 */

class HeavyPlasmaCannonTurretDualWeapon {
  constructor(firingMount = 'TurretDual', options = {}) {
    this.weaponName = 'HeavyPlasmaCannon';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 215;
    this.rateOfFireRpm = 18;
    this.muzzleVelocityKmS = 65;
    this.energyDrainMj = 28;
    this.heatGeneratedKj = 23;
    this.effectiveRangeKm = 1350;
...
module.exports = { HeavyPlasmaCannonTurretDualWeapon };
