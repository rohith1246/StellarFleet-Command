/**
 * HeavyPlasmaCannonBurstRevolverWeapon.js - Naval Weapon Battery Simulation: HeavyPlasmaCannon mounted in BurstRevolver.
 */

class HeavyPlasmaCannonBurstRevolverWeapon {
  constructor(firingMount = 'BurstRevolver', options = {}) {
    this.weaponName = 'HeavyPlasmaCannon';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 490;
    this.rateOfFireRpm = 12;
    this.muzzleVelocityKmS = 65;
    this.energyDrainMj = 61;
    this.heatGeneratedKj = 15;
    this.effectiveRangeKm = 2450;
...
module.exports = { HeavyPlasmaCannonBurstRevolverWeapon };
