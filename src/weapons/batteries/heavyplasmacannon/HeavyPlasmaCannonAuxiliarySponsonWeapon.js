/**
 * HeavyPlasmaCannonAuxiliarySponsonWeapon.js - Naval Weapon Battery Simulation: HeavyPlasmaCannon mounted in AuxiliarySponson.
 */

class HeavyPlasmaCannonAuxiliarySponsonWeapon {
  constructor(firingMount = 'AuxiliarySponson', options = {}) {
    this.weaponName = 'HeavyPlasmaCannon';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 440;
    this.rateOfFireRpm = 36;
    this.muzzleVelocityKmS = 65;
    this.energyDrainMj = 55;
    this.heatGeneratedKj = 31;
    this.effectiveRangeKm = 2250;
...
module.exports = { HeavyPlasmaCannonAuxiliarySponsonWeapon };
