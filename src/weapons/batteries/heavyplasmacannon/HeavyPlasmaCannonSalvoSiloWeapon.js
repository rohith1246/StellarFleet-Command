/**
 * HeavyPlasmaCannonSalvoSiloWeapon.js - Naval Weapon Battery Simulation: HeavyPlasmaCannon mounted in SalvoSilo.
 */

class HeavyPlasmaCannonSalvoSiloWeapon {
  constructor(firingMount = 'SalvoSilo', options = {}) {
    this.weaponName = 'HeavyPlasmaCannon';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 540;
...
module.exports = { HeavyPlasmaCannonSalvoSiloWeapon };
