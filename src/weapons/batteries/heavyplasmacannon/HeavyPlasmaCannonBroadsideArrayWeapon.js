/**
 * HeavyPlasmaCannonBroadsideArrayWeapon.js - Naval Weapon Battery Simulation: HeavyPlasmaCannon mounted in BroadsideArray.
 */

class HeavyPlasmaCannonBroadsideArrayWeapon {
  constructor(firingMount = 'BroadsideArray', options = {}) {
    this.weaponName = 'HeavyPlasmaCannon';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 265;
    this.rateOfFireRpm = 30;
    this.muzzleVelocityKmS = 65;
    this.energyDrainMj = 34;
    this.heatGeneratedKj = 39;
    this.effectiveRangeKm = 1550;
...
module.exports = { HeavyPlasmaCannonBroadsideArrayWeapon };
