/**
 * HeavyPlasmaCannonSublightPodWeapon.js - Naval Weapon Battery Simulation: HeavyPlasmaCannon mounted in SublightPod.
 */

class HeavyPlasmaCannonSublightPodWeapon {
  constructor(firingMount = 'SublightPod', options = {}) {
    this.weaponName = 'HeavyPlasmaCannon';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 415;
    this.rateOfFireRpm = 30;
    this.muzzleVelocityKmS = 65;
    this.energyDrainMj = 52;
    this.heatGeneratedKj = 23;
    this.effectiveRangeKm = 2150;
...
module.exports = { HeavyPlasmaCannonSublightPodWeapon };
