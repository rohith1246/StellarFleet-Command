/**
 * KineticRailgunOverchargedCapacitorWeapon.js - Naval Weapon Battery Simulation: KineticRailgun mounted in OverchargedCapacitor.
 */

class KineticRailgunOverchargedCapacitorWeapon {
  constructor(firingMount = 'OverchargedCapacitor', options = {}) {
    this.weaponName = 'KineticRailgun';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 425;
    this.rateOfFireRpm = 42;
    this.muzzleVelocityKmS = 50;
    this.energyDrainMj = 53;
...
module.exports = { KineticRailgunOverchargedCapacitorWeapon };
