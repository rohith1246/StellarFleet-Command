/**
 * KineticRailgunSalvoSiloWeapon.js - Naval Weapon Battery Simulation: KineticRailgun mounted in SalvoSilo.
 */

class KineticRailgunSalvoSiloWeapon {
...
module.exports = { KineticRailgunSalvoSiloWeapon };
