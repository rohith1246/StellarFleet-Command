/**
 * KineticRailgunAuxiliarySponsonWeapon.js - Naval Weapon Battery Simulation: KineticRailgun mounted in AuxiliarySponson.
 */

class KineticRailgunAuxiliarySponsonWeapon {
  constructor(firingMount = 'AuxiliarySponson', options = {}) {
    this.weaponName = 'KineticRailgun';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 400;
...
module.exports = { KineticRailgunAuxiliarySponsonWeapon };
