/**
 * KineticRailgunVentralBatteryWeapon.js - Naval Weapon Battery Simulation: KineticRailgun mounted in VentralBattery.
 */

class KineticRailgunVentralBatteryWeapon {
  constructor(firingMount = 'VentralBattery', options = {}) {
    this.weaponName = 'KineticRailgun';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 325;
    this.rateOfFireRpm = 18;
    this.muzzleVelocityKmS = 50;
    this.energyDrainMj = 41;
    this.heatGeneratedKj = 39;
    this.effectiveRangeKm = 1700;
...
module.exports = { KineticRailgunVentralBatteryWeapon };
