/**
 * KineticRailgunDorsalHardpointWeapon.js - Naval Weapon Battery Simulation: KineticRailgun mounted in DorsalHardpoint.
 */

class KineticRailgunDorsalHardpointWeapon {
  constructor(firingMount = 'DorsalHardpoint', options = {}) {
    this.weaponName = 'KineticRailgun';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 300;
...
module.exports = { KineticRailgunDorsalHardpointWeapon };
