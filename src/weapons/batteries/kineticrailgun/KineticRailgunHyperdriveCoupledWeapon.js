/**
 * KineticRailgunHyperdriveCoupledWeapon.js - Naval Weapon Battery Simulation: KineticRailgun mounted in HyperdriveCoupled.
 */

class KineticRailgunHyperdriveCoupledWeapon {
...
module.exports = { KineticRailgunHyperdriveCoupledWeapon };
