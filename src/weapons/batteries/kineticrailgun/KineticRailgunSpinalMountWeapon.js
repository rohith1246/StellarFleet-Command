/**
 * KineticRailgunSpinalMountWeapon.js - Naval Weapon Battery Simulation: KineticRailgun mounted in SpinalMount.
 */

class KineticRailgunSpinalMountWeapon {
  constructor(firingMount = 'SpinalMount', options = {}) {
    this.weaponName = 'KineticRailgun';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 150;
    this.rateOfFireRpm = 12;
    this.muzzleVelocityKmS = 50;
    this.energyDrainMj = 20;
    this.heatGeneratedKj = 15;
    this.effectiveRangeKm = 1000;
...
module.exports = { KineticRailgunSpinalMountWeapon };
