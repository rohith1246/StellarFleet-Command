/**
 * KineticRailgunContinuousBeamMountWeapon.js - Naval Weapon Battery Simulation: KineticRailgun mounted in ContinuousBeamMount.
 */

class KineticRailgunContinuousBeamMountWeapon {
  constructor(firingMount = 'ContinuousBeamMount', options = {}) {
    this.weaponName = 'KineticRailgun';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 475;
...
module.exports = { KineticRailgunContinuousBeamMountWeapon };
