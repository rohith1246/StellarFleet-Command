/**
 * KineticRailgunSublightPodWeapon.js - Naval Weapon Battery Simulation: KineticRailgun mounted in SublightPod.
 */

class KineticRailgunSublightPodWeapon {
  constructor(firingMount = 'SublightPod', options = {}) {
    this.weaponName = 'KineticRailgun';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 375;
    this.rateOfFireRpm = 30;
    this.muzzleVelocityKmS = 50;
    this.energyDrainMj = 47;
    this.heatGeneratedKj = 23;
    this.effectiveRangeKm = 1900;
...
module.exports = { KineticRailgunSublightPodWeapon };
