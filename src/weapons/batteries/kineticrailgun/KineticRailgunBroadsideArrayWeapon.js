/**
 * KineticRailgunBroadsideArrayWeapon.js - Naval Weapon Battery Simulation: KineticRailgun mounted in BroadsideArray.
 */

class KineticRailgunBroadsideArrayWeapon {
  constructor(firingMount = 'BroadsideArray', options = {}) {
    this.weaponName = 'KineticRailgun';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 225;
    this.rateOfFireRpm = 30;
    this.muzzleVelocityKmS = 50;
    this.energyDrainMj = 29;
    this.heatGeneratedKj = 39;
    this.effectiveRangeKm = 1300;
...
module.exports = { KineticRailgunBroadsideArrayWeapon };
