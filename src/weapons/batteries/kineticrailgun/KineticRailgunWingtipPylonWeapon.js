/**
 * KineticRailgunWingtipPylonWeapon.js - Naval Weapon Battery Simulation: KineticRailgun mounted in WingtipPylon.
 */

class KineticRailgunWingtipPylonWeapon {
...
module.exports = { KineticRailgunWingtipPylonWeapon };
