/**
 * KineticRailgunTurretDualWeapon.js - Naval Weapon Battery Simulation: KineticRailgun mounted in TurretDual.
 */

class KineticRailgunTurretDualWeapon {
  constructor(firingMount = 'TurretDual', options = {}) {
    this.weaponName = 'KineticRailgun';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 175;
    this.rateOfFireRpm = 18;
    this.muzzleVelocityKmS = 50;
    this.energyDrainMj = 23;
    this.heatGeneratedKj = 23;
    this.effectiveRangeKm = 1100;
...
module.exports = { KineticRailgunTurretDualWeapon };
