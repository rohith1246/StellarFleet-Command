/**
 * KineticRailgunPointDefenseGimbalWeapon.js - Naval Weapon Battery Simulation: KineticRailgun mounted in PointDefenseGimbal.
 */

class KineticRailgunPointDefenseGimbalWeapon {
  constructor(firingMount = 'PointDefenseGimbal', options = {}) {
    this.weaponName = 'KineticRailgun';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 250;
    this.rateOfFireRpm = 36;
    this.muzzleVelocityKmS = 50;
    this.energyDrainMj = 32;
    this.heatGeneratedKj = 15;
    this.effectiveRangeKm = 1400;
...
module.exports = { KineticRailgunPointDefenseGimbalWeapon };
