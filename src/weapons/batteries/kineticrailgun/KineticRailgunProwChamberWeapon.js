/**
 * KineticRailgunProwChamberWeapon.js - Naval Weapon Battery Simulation: KineticRailgun mounted in ProwChamber.
 */

class KineticRailgunProwChamberWeapon {
  constructor(firingMount = 'ProwChamber', options = {}) {
    this.weaponName = 'KineticRailgun';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 275;
...
module.exports = { KineticRailgunProwChamberWeapon };
