/**
 * KineticRailgunBurstRevolverWeapon.js - Naval Weapon Battery Simulation: KineticRailgun mounted in BurstRevolver.
 */

class KineticRailgunBurstRevolverWeapon {
...
module.exports = { KineticRailgunBurstRevolverWeapon };
