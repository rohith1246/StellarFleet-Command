/**
 * TachyonLanceSalvoSiloWeapon.js - Naval Weapon Battery Simulation: TachyonLance mounted in SalvoSilo.
 */

class TachyonLanceSalvoSiloWeapon {
...
module.exports = { TachyonLanceSalvoSiloWeapon };
