/**
 * TachyonLanceSpinalMountWeapon.js - Naval Weapon Battery Simulation: TachyonLance mounted in SpinalMount.
 */

class TachyonLanceSpinalMountWeapon {
  constructor(firingMount = 'SpinalMount', options = {}) {
    this.weaponName = 'TachyonLance';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 230;
    this.rateOfFireRpm = 12;
    this.muzzleVelocityKmS = 80;
    this.energyDrainMj = 30;
    this.heatGeneratedKj = 15;
    this.effectiveRangeKm = 1500;
...
module.exports = { TachyonLanceSpinalMountWeapon };
