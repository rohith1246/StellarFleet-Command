/**
 * TachyonLanceContinuousBeamMountWeapon.js - Naval Weapon Battery Simulation: TachyonLance mounted in ContinuousBeamMount.
 */

class TachyonLanceContinuousBeamMountWeapon {
  constructor(firingMount = 'ContinuousBeamMount', options = {}) {
    this.weaponName = 'TachyonLance';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 555;
    this.rateOfFireRpm = 18;
    this.muzzleVelocityKmS = 80;
    this.energyDrainMj = 69;
...
module.exports = { TachyonLanceContinuousBeamMountWeapon };
