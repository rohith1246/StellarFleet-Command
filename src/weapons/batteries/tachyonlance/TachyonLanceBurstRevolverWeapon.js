/**
 * TachyonLanceBurstRevolverWeapon.js - Naval Weapon Battery Simulation: TachyonLance mounted in BurstRevolver.
 */

class TachyonLanceBurstRevolverWeapon {
...
module.exports = { TachyonLanceBurstRevolverWeapon };
