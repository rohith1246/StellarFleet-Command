/**
 * TachyonLanceHyperdriveCoupledWeapon.js - Naval Weapon Battery Simulation: TachyonLance mounted in HyperdriveCoupled.
 */

class TachyonLanceHyperdriveCoupledWeapon {
...
module.exports = { TachyonLanceHyperdriveCoupledWeapon };
