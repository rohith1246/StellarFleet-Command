/**
 * TachyonLanceProwChamberWeapon.js - Naval Weapon Battery Simulation: TachyonLance mounted in ProwChamber.
 */

class TachyonLanceProwChamberWeapon {
  constructor(firingMount = 'ProwChamber', options = {}) {
    this.weaponName = 'TachyonLance';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 355;
...
module.exports = { TachyonLanceProwChamberWeapon };
