/**
 * TachyonLanceAuxiliarySponsonWeapon.js - Naval Weapon Battery Simulation: TachyonLance mounted in AuxiliarySponson.
 */

class TachyonLanceAuxiliarySponsonWeapon {
  constructor(firingMount = 'AuxiliarySponson', options = {}) {
    this.weaponName = 'TachyonLance';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 480;
...
module.exports = { TachyonLanceAuxiliarySponsonWeapon };
