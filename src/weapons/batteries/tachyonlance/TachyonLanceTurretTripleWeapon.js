/**
 * TachyonLanceTurretTripleWeapon.js - Naval Weapon Battery Simulation: TachyonLance mounted in TurretTriple.
 */

class TachyonLanceTurretTripleWeapon {
  constructor(firingMount = 'TurretTriple', options = {}) {
    this.weaponName = 'TachyonLance';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 280;
    this.rateOfFireRpm = 24;
    this.muzzleVelocityKmS = 80;
    this.energyDrainMj = 36;
...
module.exports = { TachyonLanceTurretTripleWeapon };
