/**
 * TachyonLanceOverchargedCapacitorWeapon.js - Naval Weapon Battery Simulation: TachyonLance mounted in OverchargedCapacitor.
 */

class TachyonLanceOverchargedCapacitorWeapon {
  constructor(firingMount = 'OverchargedCapacitor', options = {}) {
    ...
    this.energyDrainMj = 63;
    this.heatGeneratedKj = 39;
    this.effectiveRangeKm = 2600;
...
module.exports = { TachyonLanceOverchargedCapacitorWeapon };
