/**
 * TachyonLancePointDefenseGimbalWeapon.js - Naval Weapon Battery Simulation: TachyonLance mounted in PointDefenseGimbal.
 */

class TachyonLancePointDefenseGimbalWeapon {
  constructor(firingMount = 'PointDefenseGimbal', options = {}) {
    this.weaponName = 'TachyonLance';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 330;
    this.rateOfFireRpm = 36;
    this.muzzleVelocityKmS = 80;
    this.energyDrainMj = 42;
...
module.exports = { TachyonLancePointDefenseGimbalWeapon };
