/**
 * TachyonLanceTurretDualWeapon.js - Naval Weapon Battery Simulation: TachyonLance mounted in TurretDual.
 */

class TachyonLanceTurretDualWeapon {
  constructor(firingMount = 'TurretDual', options = {}) {
    this.weaponName = 'TachyonLance';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 255;
    this.rateOfFireRpm = 18;
    this.muzzleVelocityKmS = 80;
    this.energyDrainMj = 33;
    this.heatGeneratedKj = 23;
    this.effectiveRangeKm = 1600;
...
module.exports = { TachyonLanceTurretDualWeapon };
