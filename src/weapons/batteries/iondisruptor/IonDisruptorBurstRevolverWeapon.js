/**
 * IonDisruptorBurstRevolverWeapon.js - Naval Weapon Battery Simulation: IonDisruptor mounted in BurstRevolver.
 */

class IonDisruptorBurstRevolverWeapon {
...
module.exports = { IonDisruptorBurstRevolverWeapon };
