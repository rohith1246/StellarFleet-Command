/**
 * IonDisruptorAuxiliarySponsonWeapon.js - Naval Weapon Battery Simulation: IonDisruptor mounted in AuxiliarySponson.
 */

class IonDisruptorAuxiliarySponsonWeapon {
...
module.exports = { IonDisruptorAuxiliarySponsonWeapon };
