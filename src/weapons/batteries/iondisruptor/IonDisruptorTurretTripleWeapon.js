/**
 * IonDisruptorTurretTripleWeapon.js - Naval Weapon Battery Simulation: IonDisruptor mounted in TurretTriple.
 */

class IonDisruptorTurretTripleWeapon {
...
module.exports = { IonDisruptorTurretTripleWeapon };
