/**
 * IonDisruptorSpinalMountWeapon.js - Naval Weapon Battery Simulation: IonDisruptor mounted in SpinalMount.
 */

class IonDisruptorSpinalMountWeapon {
  constructor(firingMount = 'SpinalMount', options = {}) {
    ...
    this.energyDrainMj = 50;
    this.heatGeneratedKj = 15;
    this.effectiveRangeKm = 2500;
...
module.exports = { IonDisruptorSpinalMountWeapon };
