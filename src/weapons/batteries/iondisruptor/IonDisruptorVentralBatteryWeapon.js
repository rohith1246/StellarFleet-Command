/**
 * IonDisruptorVentralBatteryWeapon.js - Naval Weapon Battery Simulation: IonDisruptor mounted in VentralBattery.
 */

class IonDisruptorVentralBatteryWeapon {
...
module.exports = { IonDisruptorVentralBatteryWeapon };
