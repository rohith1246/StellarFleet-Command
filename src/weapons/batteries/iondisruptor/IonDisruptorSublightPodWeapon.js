/**
 * IonDisruptorSublightPodWeapon.js - Naval Weapon Battery Simulation: IonDisruptor mounted in SublightPod.
 */

class IonDisruptorSublightPodWeapon {
  constructor(firingMount = 'SublightPod', options = {}) {
    ...
    this.energyDrainMj = 77;
    this.heatGeneratedKj = 23;
    this.effectiveRangeKm = 3400;
...
module.exports = { IonDisruptorSublightPodWeapon };
