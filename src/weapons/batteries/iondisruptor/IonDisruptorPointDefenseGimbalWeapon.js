/**
 * IonDisruptorPointDefenseGimbalWeapon.js - Naval Weapon Battery Simulation: IonDisruptor mounted in PointDefenseGimbal.
 */

class IonDisruptorPointDefenseGimbalWeapon {
...
module.exports = { IonDisruptorPointDefenseGimbalWeapon };
