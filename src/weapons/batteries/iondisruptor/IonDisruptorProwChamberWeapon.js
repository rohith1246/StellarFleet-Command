/**
 * IonDisruptorProwChamberWeapon.js - Naval Weapon Battery Simulation: IonDisruptor mounted in ProwChamber.
 */

class IonDisruptorProwChamberWeapon {
...
module.exports = { IonDisruptorProwChamberWeapon };
