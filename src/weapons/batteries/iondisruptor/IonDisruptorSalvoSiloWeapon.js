/**
 * IonDisruptorSalvoSiloWeapon.js - Naval Weapon Battery Simulation: IonDisruptor mounted in SalvoSilo.
 */

class IonDisruptorSalvoSiloWeapon {
...
module.exports = { IonDisruptorSalvoSiloWeapon };
