/**
 * IonDisruptorWingtipPylonWeapon.js - Naval Weapon Battery Simulation: IonDisruptor mounted in WingtipPylon.
 */

class IonDisruptorWingtipPylonWeapon {
...
module.exports = { IonDisruptorWingtipPylonWeapon };
