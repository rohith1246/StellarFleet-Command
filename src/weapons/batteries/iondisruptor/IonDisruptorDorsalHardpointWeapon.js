/**
 * IonDisruptorDorsalHardpointWeapon.js - Naval Weapon Battery Simulation: IonDisruptor mounted in DorsalHardpoint.
 */

class IonDisruptorDorsalHardpointWeapon {
...
module.exports = { IonDisruptorDorsalHardpointWeapon };
