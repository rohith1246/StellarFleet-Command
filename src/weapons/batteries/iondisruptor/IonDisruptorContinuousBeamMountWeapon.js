/**
 * IonDisruptorContinuousBeamMountWeapon.js - Naval Weapon Battery Simulation: IonDisruptor mounted in ContinuousBeamMount.
 */

class IonDisruptorContinuousBeamMountWeapon {
  constructor(firingMount = 'ContinuousBeamMount', options = {}) {
    this.weaponName = 'IonDisruptor';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 715;
    this.rateOfFireRpm = 18;
    this.muzzleVelocityKmS = 140;
    this.energyDrainMj = 89;
    this.heatGeneratedKj = 23;
    this.effectiveRangeKm = 3800;
...
module.exports = { IonDisruptorContinuousBeamMountWeapon };
