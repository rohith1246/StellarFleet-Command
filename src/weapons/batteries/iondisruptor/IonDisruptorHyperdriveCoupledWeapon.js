/**
 * IonDisruptorHyperdriveCoupledWeapon.js - Naval Weapon Battery Simulation: IonDisruptor mounted in HyperdriveCoupled.
 */

class IonDisruptorHyperdriveCoupledWeapon {
...
module.exports = { IonDisruptorHyperdriveCoupledWeapon };
