/**
 * IonDisruptorTurretDualWeapon.js - Naval Weapon Battery Simulation: IonDisruptor mounted in TurretDual.
 */

class IonDisruptorTurretDualWeapon {
...
module.exports = { IonDisruptorTurretDualWeapon };
