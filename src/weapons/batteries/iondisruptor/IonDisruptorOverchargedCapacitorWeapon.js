/**
 * IonDisruptorOverchargedCapacitorWeapon.js - Naval Weapon Battery Simulation: IonDisruptor mounted in OverchargedCapacitor.
 */

class IonDisruptorOverchargedCapacitorWeapon {
  constructor(firingMount = 'OverchargedCapacitor', options = {}) {
    this.weaponName = 'IonDisruptor';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 665;
    this.rateOfFireRpm = 42;
    this.muzzleVelocityKmS = 140;
    this.energyDrainMj = 83;
    this.heatGeneratedKj = 39;
    this.effectiveRangeKm = 3600;
...
module.exports = { IonDisruptorOverchargedCapacitorWeapon };
