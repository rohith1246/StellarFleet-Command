/**
 * ProtonTorpedoAuxiliarySponsonWeapon.js - Naval Weapon Battery Simulation: ProtonTorpedo mounted in AuxiliarySponson.
 */

class ProtonTorpedoAuxiliarySponsonWeapon {
  constructor(firingMount = 'AuxiliarySponson', options = {}) {
    this.weaponName = 'ProtonTorpedo';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 560;
...
module.exports = { ProtonTorpedoAuxiliarySponsonWeapon };
