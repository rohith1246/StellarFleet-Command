/**
 * ProtonTorpedoBroadsideArrayWeapon.js - Naval Weapon Battery Simulation: ProtonTorpedo mounted in BroadsideArray.
 */

class ProtonTorpedoBroadsideArrayWeapon {
  constructor(firingMount = 'BroadsideArray', options = {}) {
    this.weaponName = 'ProtonTorpedo';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 385;
...
module.exports = { ProtonTorpedoBroadsideArrayWeapon };
