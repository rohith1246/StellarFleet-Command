/**
 * ProtonTorpedoHyperdriveCoupledWeapon.js - Naval Weapon Battery Simulation: ProtonTorpedo mounted in HyperdriveCoupled.
 */

class ProtonTorpedoHyperdriveCoupledWeapon {
...
module.exports = { ProtonTorpedoHyperdriveCoupledWeapon };
