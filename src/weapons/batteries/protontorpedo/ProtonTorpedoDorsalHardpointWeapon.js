/**
 * ProtonTorpedoDorsalHardpointWeapon.js - Naval Weapon Battery Simulation: ProtonTorpedo mounted in DorsalHardpoint.
 */

class ProtonTorpedoDorsalHardpointWeapon {
  constructor(firingMount = 'DorsalHardpoint', options = {}) {
    this.weaponName = 'ProtonTorpedo';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 460;
...
module.exports = { ProtonTorpedoDorsalHardpointWeapon };
