/**
 * ProtonTorpedoTurretDualWeapon.js - Naval Weapon Battery Simulation: ProtonTorpedo mounted in TurretDual.
 */

class ProtonTorpedoTurretDualWeapon {
  constructor(firingMount = 'TurretDual', options = {}) {
    this.weaponName = 'ProtonTorpedo';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 335;
...
module.exports = { ProtonTorpedoTurretDualWeapon };
