/**
 * ProtonTorpedoProwChamberWeapon.js - Naval Weapon Battery Simulation: ProtonTorpedo mounted in ProwChamber.
 */

class ProtonTorpedoProwChamberWeapon {
  constructor(firingMount = 'ProwChamber', options = {}) {
    this.weaponName = 'ProtonTorpedo';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 435;
...
module.exports = { ProtonTorpedoProwChamberWeapon };
