/**
 * ProtonTorpedoVentralBatteryWeapon.js - Naval Weapon Battery Simulation: ProtonTorpedo mounted in VentralBattery.
 */

class ProtonTorpedoVentralBatteryWeapon {
  constructor(firingMount = 'VentralBattery', options = {}) {
    this.weaponName = 'ProtonTorpedo';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 485;
    this.rateOfFireRpm = 18;
    this.muzzleVelocityKmS = 110;
    this.energyDrainMj = 61;
    this.heatGeneratedKj = 39;
    this.effectiveRangeKm = 2700;
...
module.exports = { ProtonTorpedoVentralBatteryWeapon };
