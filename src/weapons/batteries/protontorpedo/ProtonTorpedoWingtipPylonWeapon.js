/**
 * ProtonTorpedoWingtipPylonWeapon.js - Naval Weapon Battery Simulation: ProtonTorpedo mounted in WingtipPylon.
 */

class ProtonTorpedoWingtipPylonWeapon {
...
module.exports = { ProtonTorpedoWingtipPylonWeapon };
