/**
 * ProtonTorpedoPointDefenseGimbalWeapon.js - Naval Weapon Battery Simulation: ProtonTorpedo mounted in PointDefenseGimbal.
 */

class ProtonTorpedoPointDefenseGimbalWeapon {
  constructor(firingMount = 'PointDefenseGimbal', options = {}) {
    this.weaponName = 'ProtonTorpedo';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 410;
...
module.exports = { ProtonTorpedoPointDefenseGimbalWeapon };
