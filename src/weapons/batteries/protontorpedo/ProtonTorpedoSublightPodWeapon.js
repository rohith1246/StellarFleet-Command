/**
 * ProtonTorpedoSublightPodWeapon.js - Naval Weapon Battery Simulation: ProtonTorpedo mounted in SublightPod.
 */

class ProtonTorpedoSublightPodWeapon {
  constructor(firingMount = 'SublightPod', options = {}) {
    this.weaponName = 'ProtonTorpedo';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 535;
    this.rateOfFireRpm = 30;
    this.muzzleVelocityKmS = 110;
    this.energyDrainMj = 67;
    this.heatGeneratedKj = 23;
    this.effectiveRangeKm = 2900;
...
module.exports = { ProtonTorpedoSublightPodWeapon };
