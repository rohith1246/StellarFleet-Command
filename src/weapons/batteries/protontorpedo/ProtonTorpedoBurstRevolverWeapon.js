/**
 * ProtonTorpedoBurstRevolverWeapon.js - Naval Weapon Battery Simulation: ProtonTorpedo mounted in BurstRevolver.
 */

class ProtonTorpedoBurstRevolverWeapon {
...
module.exports = { ProtonTorpedoBurstRevolverWeapon };
