/**
 * ProtonTorpedoOverchargedCapacitorWeapon.js - Naval Weapon Battery Simulation: ProtonTorpedo mounted in OverchargedCapacitor.
 */

class ProtonTorpedoOverchargedCapacitorWeapon {
  constructor(firingMount = 'OverchargedCapacitor', options = {}) {
    this.weaponName = 'ProtonTorpedo';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 585;
    this.rateOfFireRpm = 42;
    this.muzzleVelocityKmS = 110;
    this.energyDrainMj = 73;
    this.heatGeneratedKj = 39;
    this.effectiveRangeKm = 3100;
...
module.exports = { ProtonTorpedoOverchargedCapacitorWeapon };
