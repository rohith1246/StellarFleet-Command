/**
 * ProtonTorpedoTurretTripleWeapon.js - Naval Weapon Battery Simulation: ProtonTorpedo mounted in TurretTriple.
 */

class ProtonTorpedoTurretTripleWeapon {
  constructor(firingMount = 'TurretTriple', options = {}) {
    this.weaponName = 'ProtonTorpedo';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 360;
...
module.exports = { ProtonTorpedoTurretTripleWeapon };
