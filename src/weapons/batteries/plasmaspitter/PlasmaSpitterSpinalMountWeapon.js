/**
 * PlasmaSpitterSpinalMountWeapon.js - Naval Weapon Battery Simulation: PlasmaSpitter mounted in SpinalMount.
 */

class PlasmaSpitterSpinalMountWeapon {
...
module.exports = { PlasmaSpitterSpinalMountWeapon };
