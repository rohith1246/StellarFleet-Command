/**
 * PlasmaSpitterPointDefenseGimbalWeapon.js - Naval Weapon Battery Simulation: PlasmaSpitter mounted in PointDefenseGimbal.
 */

class PlasmaSpitterPointDefenseGimbalWeapon {
  constructor(firingMount = 'PointDefenseGimbal', options = {}) {
    this.weaponName = 'PlasmaSpitter';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 770;
...
module.exports = { PlasmaSpitterPointDefenseGimbalWeapon };
