/**
 * PlasmaSpitterProwChamberWeapon.js - Naval Weapon Battery Simulation: PlasmaSpitter mounted in ProwChamber.
 */

class PlasmaSpitterProwChamberWeapon {
...
module.exports = { PlasmaSpitterProwChamberWeapon };
