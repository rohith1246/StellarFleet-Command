/**
 * PlasmaSpitterTurretDualWeapon.js - Naval Weapon Battery Simulation: PlasmaSpitter mounted in TurretDual.
 */

class PlasmaSpitterTurretDualWeapon {
...
module.exports = { PlasmaSpitterTurretDualWeapon };
