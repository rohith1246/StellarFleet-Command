/**
 * PlasmaSpitterOverchargedCapacitorWeapon.js - Naval Weapon Battery Simulation: PlasmaSpitter mounted in OverchargedCapacitor.
 */

class PlasmaSpitterOverchargedCapacitorWeapon {
  constructor(firingMount = 'OverchargedCapacitor', options = {}) {
    this.weaponName = 'PlasmaSpitter';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 945;
    this.rateOfFireRpm = 42;
    this.muzzleVelocityKmS = 125;
    this.energyDrainMj = 118;
    this.heatGeneratedKj = 39;
    this.effectiveRangeKm = 5350;
...
module.exports = { PlasmaSpitterOverchargedCapacitorWeapon };
