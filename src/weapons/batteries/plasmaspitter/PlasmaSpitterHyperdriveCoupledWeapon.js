/**
 * PlasmaSpitterHyperdriveCoupledWeapon.js - Naval Weapon Battery Simulation: PlasmaSpitter mounted in HyperdriveCoupled.
 */

class PlasmaSpitterHyperdriveCoupledWeapon {
  constructor(firingMount = 'HyperdriveCoupled', options = {}) {
    this.weaponName = 'PlasmaSpitter';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 1045;
    this.rateOfFireRpm = 30;
    this.muzzleVelocityKmS = 125;
    this.energyDrainMj = 130;
...
module.exports = { PlasmaSpitterHyperdriveCoupledWeapon };
