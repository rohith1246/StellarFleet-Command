/**
 * PlasmaSpitterBurstRevolverWeapon.js - Naval Weapon Battery Simulation: PlasmaSpitter mounted in BurstRevolver.
 */

class PlasmaSpitterBurstRevolverWeapon {
  constructor(firingMount = 'BurstRevolver', options = {}) {
    this.weaponName = 'PlasmaSpitter';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 970;
    this.rateOfFireRpm = 12;
    this.muzzleVelocityKmS = 125;
    this.energyDrainMj = 121;
...
module.exports = { PlasmaSpitterBurstRevolverWeapon };
