/**
 * PlasmaSpitterWingtipPylonWeapon.js - Naval Weapon Battery Simulation: PlasmaSpitter mounted in WingtipPylon.
 */

class PlasmaSpitterWingtipPylonWeapon {
  constructor(firingMount = 'WingtipPylon', options = {}) {
    this.weaponName = 'PlasmaSpitter';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 870;
...
module.exports = { PlasmaSpitterWingtipPylonWeapon };
