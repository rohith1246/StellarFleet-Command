/**
 * PlasmaSpitterDorsalHardpointWeapon.js - Naval Weapon Battery Simulation: PlasmaSpitter mounted in DorsalHardpoint.
 */

class PlasmaSpitterDorsalHardpointWeapon {
  constructor(firingMount = 'DorsalHardpoint', options = {}) {
    this.weaponName = 'PlasmaSpitter';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 820;
...
module.exports = { PlasmaSpitterDorsalHardpointWeapon };
