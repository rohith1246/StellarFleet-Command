/**
 * PlasmaSpitterBroadsideArrayWeapon.js - Naval Weapon Battery Simulation: PlasmaSpitter mounted in BroadsideArray.
 */

class PlasmaSpitterBroadsideArrayWeapon {
...
module.exports = { PlasmaSpitterBroadsideArrayWeapon };
