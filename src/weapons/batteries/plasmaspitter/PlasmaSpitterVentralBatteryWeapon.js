/**
 * PlasmaSpitterVentralBatteryWeapon.js - Naval Weapon Battery Simulation: PlasmaSpitter mounted in VentralBattery.
 */

class PlasmaSpitterVentralBatteryWeapon {
...
module.exports = { PlasmaSpitterVentralBatteryWeapon };
