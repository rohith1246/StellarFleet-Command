/**
 * PlasmaSpitterTurretTripleWeapon.js - Naval Weapon Battery Simulation: PlasmaSpitter mounted in TurretTriple.
 */

class PlasmaSpitterTurretTripleWeapon {
  constructor(firingMount = 'TurretTriple', options = {}) {
    this.weaponName = 'PlasmaSpitter';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 720;
    this.rateOfFireRpm = 24;
    this.muzzleVelocityKmS = 125;
    this.energyDrainMj = 91;
...
module.exports = { PlasmaSpitterTurretTripleWeapon };
