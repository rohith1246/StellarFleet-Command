/**
 * PlasmaSpitterAuxiliarySponsonWeapon.js - Naval Weapon Battery Simulation: PlasmaSpitter mounted in AuxiliarySponson.
 */

class PlasmaSpitterAuxiliarySponsonWeapon {
  constructor(firingMount = 'AuxiliarySponson', options = {}) {
    this.weaponName = 'PlasmaSpitter';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 920;
...
module.exports = { PlasmaSpitterAuxiliarySponsonWeapon };
