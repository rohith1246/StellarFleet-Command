/**
 * PlasmaSpitterContinuousBeamMountWeapon.js - Naval Weapon Battery Simulation: PlasmaSpitter mounted in ContinuousBeamMount.
 */

class PlasmaSpitterContinuousBeamMountWeapon {
  constructor(firingMount = 'ContinuousBeamMount', options = {}) {
    this.weaponName = 'PlasmaSpitter';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 995;
    this.rateOfFireRpm = 18;
    this.muzzleVelocityKmS = 125;
    this.energyDrainMj = 124;
    this.heatGeneratedKj = 23;
    this.effectiveRangeKm = 5550;
...
module.exports = { PlasmaSpitterContinuousBeamMountWeapon };
