/**
 * PlasmaSpitterSublightPodWeapon.js - Naval Weapon Battery Simulation: PlasmaSpitter mounted in SublightPod.
 */

class PlasmaSpitterSublightPodWeapon {
  constructor(firingMount = 'SublightPod', options = {}) {
    this.weaponName = 'PlasmaSpitter';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 895;
    this.rateOfFireRpm = 30;
    this.muzzleVelocityKmS = 125;
    this.energyDrainMj = 112;
...
module.exports = { PlasmaSpitterSublightPodWeapon };
