/**
 * GravitonProjectorDorsalHardpointWeapon.js - Naval Weapon Battery Simulation: GravitonProjector mounted in DorsalHardpoint.
 */

class GravitonProjectorDorsalHardpointWeapon {
  constructor(firingMount = 'DorsalHardpoint', options = {}) {
    this.weaponName = 'GravitonProjector';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 700;
...
module.exports = { GravitonProjectorDorsalHardpointWeapon };
