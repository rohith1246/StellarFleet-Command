/**
 * GravitonProjectorOverchargedCapacitorWeapon.js - Naval Weapon Battery Simulation: GravitonProjector mounted in OverchargedCapacitor.
 */

class GravitonProjectorOverchargedCapacitorWeapon {
  constructor(firingMount = 'OverchargedCapacitor', options = {}) {
    this.weaponName = 'GravitonProjector';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 825;
    this.rateOfFireRpm = 42;
    this.muzzleVelocityKmS = 80;
    this.energyDrainMj = 103;
    this.heatGeneratedKj = 39;
    this.effectiveRangeKm = 4600;
...
module.exports = { GravitonProjectorOverchargedCapacitorWeapon };
