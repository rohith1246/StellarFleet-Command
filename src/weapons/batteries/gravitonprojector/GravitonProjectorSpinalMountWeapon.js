/**
 * GravitonProjectorSpinalMountWeapon.js - Naval Weapon Battery Simulation: GravitonProjector mounted in SpinalMount.
 */

class GravitonProjectorSpinalMountWeapon {
  constructor(firingMount = 'SpinalMount', options = {}) {
    this.weaponName = 'GravitonProjector';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 550;
    this.rateOfFireRpm = 12;
    this.muzzleVelocityKmS = 80;
    this.energyDrainMj = 70;
    this.heatGeneratedKj = 15;
    this.effectiveRangeKm = 3500;
...
module.exports = { GravitonProjectorSpinalMountWeapon };
