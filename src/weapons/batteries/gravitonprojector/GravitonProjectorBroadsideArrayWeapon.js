/**
 * GravitonProjectorBroadsideArrayWeapon.js - Naval Weapon Battery Simulation: GravitonProjector mounted in BroadsideArray.
 */

class GravitonProjectorBroadsideArrayWeapon {
...
module.exports = { GravitonProjectorBroadsideArrayWeapon };
