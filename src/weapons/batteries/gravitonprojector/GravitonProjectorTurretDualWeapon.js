/**
 * GravitonProjectorTurretDualWeapon.js - Naval Weapon Battery Simulation: GravitonProjector mounted in TurretDual.
 */

class GravitonProjectorTurretDualWeapon {
...
module.exports = { GravitonProjectorTurretDualWeapon };
