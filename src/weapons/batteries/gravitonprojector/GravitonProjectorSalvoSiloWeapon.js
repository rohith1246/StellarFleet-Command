/**
 * GravitonProjectorSalvoSiloWeapon.js - Naval Weapon Battery Simulation: GravitonProjector mounted in SalvoSilo.
 */

class GravitonProjectorSalvoSiloWeapon {
...
module.exports = { GravitonProjectorSalvoSiloWeapon };
