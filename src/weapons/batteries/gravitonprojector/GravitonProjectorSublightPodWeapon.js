/**
 * GravitonProjectorSublightPodWeapon.js - Naval Weapon Battery Simulation: GravitonProjector mounted in SublightPod.
 */

class GravitonProjectorSublightPodWeapon {
  constructor(firingMount = 'SublightPod', options = {}) {
    ...
    this.energyDrainMj = 97;
    this.heatGeneratedKj = 23;
    this.effectiveRangeKm = 4400;
...
module.exports = { GravitonProjectorSublightPodWeapon };
