/**
 * GravitonProjectorHyperdriveCoupledWeapon.js - Naval Weapon Battery Simulation: GravitonProjector mounted in HyperdriveCoupled.
 */

class GravitonProjectorHyperdriveCoupledWeapon {
  constructor(firingMount = 'HyperdriveCoupled', options = {}) {
    this.weaponName = 'GravitonProjector';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 925;
    this.rateOfFireRpm = 30;
    this.muzzleVelocityKmS = 80;
    this.energyDrainMj = 115;
    this.heatGeneratedKj = 39;
    this.effectiveRangeKm = 5000;
...
module.exports = { GravitonProjectorHyperdriveCoupledWeapon };
