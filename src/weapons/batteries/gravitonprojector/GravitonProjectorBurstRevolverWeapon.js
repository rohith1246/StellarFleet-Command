/**
 * GravitonProjectorBurstRevolverWeapon.js - Naval Weapon Battery Simulation: GravitonProjector mounted in BurstRevolver.
 */

class GravitonProjectorBurstRevolverWeapon {
...
module.exports = { GravitonProjectorBurstRevolverWeapon };
