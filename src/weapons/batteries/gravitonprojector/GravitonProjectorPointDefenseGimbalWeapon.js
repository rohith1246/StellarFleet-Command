/**
 * GravitonProjectorPointDefenseGimbalWeapon.js - Naval Weapon Battery Simulation: GravitonProjector mounted in PointDefenseGimbal.
 */

class GravitonProjectorPointDefenseGimbalWeapon {
  constructor(firingMount = 'PointDefenseGimbal', options = {}) {
    this.weaponName = 'GravitonProjector';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 650;
    this.rateOfFireRpm = 36;
    this.muzzleVelocityKmS = 80;
    this.energyDrainMj = 82;
...
module.exports = { GravitonProjectorPointDefenseGimbalWeapon };
