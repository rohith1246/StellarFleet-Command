/**
 * GravitonProjectorContinuousBeamMountWeapon.js - Naval Weapon Battery Simulation: GravitonProjector mounted in ContinuousBeamMount.
 */

class GravitonProjectorContinuousBeamMountWeapon {
  constructor(firingMount = 'ContinuousBeamMount', options = {}) {
    this.weaponName = 'GravitonProjector';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 875;
    this.rateOfFireRpm = 18;
    this.muzzleVelocityKmS = 80;
    this.energyDrainMj = 109;
    this.heatGeneratedKj = 23;
    this.effectiveRangeKm = 4800;
...
module.exports = { GravitonProjectorContinuousBeamMountWeapon };
