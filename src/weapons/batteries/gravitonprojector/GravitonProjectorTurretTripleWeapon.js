/**
 * GravitonProjectorTurretTripleWeapon.js - Naval Weapon Battery Simulation: GravitonProjector mounted in TurretTriple.
 */

class GravitonProjectorTurretTripleWeapon {
...
module.exports = { GravitonProjectorTurretTripleWeapon };
