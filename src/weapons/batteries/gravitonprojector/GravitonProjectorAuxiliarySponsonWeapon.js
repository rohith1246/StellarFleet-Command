/**
 * GravitonProjectorAuxiliarySponsonWeapon.js - Naval Weapon Battery Simulation: GravitonProjector mounted in AuxiliarySponson.
 */

class GravitonProjectorAuxiliarySponsonWeapon {
  constructor(firingMount = 'AuxiliarySponson', options = {}) {
    this.weaponName = 'GravitonProjector';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 800;
    this.rateOfFireRpm = 36;
    this.muzzleVelocityKmS = 80;
    this.energyDrainMj = 100;
    this.heatGeneratedKj = 31;
    this.effectiveRangeKm = 4500;
...
module.exports = { GravitonProjectorAuxiliarySponsonWeapon };
