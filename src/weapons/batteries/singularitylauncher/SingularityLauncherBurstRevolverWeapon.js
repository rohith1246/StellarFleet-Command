/**
 * SingularityLauncherBurstRevolverWeapon.js - Naval Weapon Battery Simulation: SingularityLauncher mounted in BurstRevolver.
 */

class SingularityLauncherBurstRevolverWeapon {
  constructor(firingMount = 'BurstRevolver', options = {}) {
    this.weaponName = 'SingularityLauncher';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 1050;
    this.rateOfFireRpm = 12;
    this.muzzleVelocityKmS = 155;
    this.energyDrainMj = 131;
    this.heatGeneratedKj = 15;
    this.effectiveRangeKm = 5950;
...
module.exports = { SingularityLauncherBurstRevolverWeapon };
