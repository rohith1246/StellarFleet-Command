/**
 * SingularityLauncherWingtipPylonWeapon.js - Naval Weapon Battery Simulation: SingularityLauncher mounted in WingtipPylon.
 */

class SingularityLauncherWingtipPylonWeapon {
  constructor(firingMount = 'WingtipPylon', options = {}) {
    this.weaponName = 'SingularityLauncher';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 950;
    this.rateOfFireRpm = 24;
    this.muzzleVelocityKmS = 155;
    this.energyDrainMj = 119;
...
module.exports = { SingularityLauncherWingtipPylonWeapon };
