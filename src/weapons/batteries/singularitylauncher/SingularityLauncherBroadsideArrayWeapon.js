/**
 * SingularityLauncherBroadsideArrayWeapon.js - Naval Weapon Battery Simulation: SingularityLauncher mounted in BroadsideArray.
 */

class SingularityLauncherBroadsideArrayWeapon {
...
module.exports = { SingularityLauncherBroadsideArrayWeapon };
