/**
 * SingularityLauncherAuxiliarySponsonWeapon.js - Naval Weapon Battery Simulation: SingularityLauncher mounted in AuxiliarySponson.
 */

class SingularityLauncherAuxiliarySponsonWeapon {
  constructor(firingMount = 'AuxiliarySponson', options = {}) {
    this.weaponName = 'SingularityLauncher';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 1000;
    this.rateOfFireRpm = 36;
    this.muzzleVelocityKmS = 155;
    this.energyDrainMj = 125;
    this.heatGeneratedKj = 31;
    this.effectiveRangeKm = 5750;
...
module.exports = { SingularityLauncherAuxiliarySponsonWeapon };
