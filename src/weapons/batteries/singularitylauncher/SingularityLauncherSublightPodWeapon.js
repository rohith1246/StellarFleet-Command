/**
 * SingularityLauncherSublightPodWeapon.js - Naval Weapon Battery Simulation: SingularityLauncher mounted in SublightPod.
 */

class SingularityLauncherSublightPodWeapon {
  constructor(firingMount = 'SublightPod', options = {}) {
    this.weaponName = 'SingularityLauncher';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 975;
    this.rateOfFireRpm = 30;
    this.muzzleVelocityKmS = 155;
    this.energyDrainMj = 122;
...
module.exports = { SingularityLauncherSublightPodWeapon };
