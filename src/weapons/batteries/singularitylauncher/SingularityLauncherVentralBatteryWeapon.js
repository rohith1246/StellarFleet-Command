/**
 * SingularityLauncherVentralBatteryWeapon.js - Naval Weapon Battery Simulation: SingularityLauncher mounted in VentralBattery.
 */

class SingularityLauncherVentralBatteryWeapon {
...
module.exports = { SingularityLauncherVentralBatteryWeapon };
