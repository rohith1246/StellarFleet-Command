/**
 * SingularityLauncherOverchargedCapacitorWeapon.js - Naval Weapon Battery Simulation: SingularityLauncher mounted in OverchargedCapacitor.
 */

class SingularityLauncherOverchargedCapacitorWeapon {
  constructor(firingMount = 'OverchargedCapacitor', options = {}) {
    this.weaponName = 'SingularityLauncher';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 1025;
    this.rateOfFireRpm = 42;
    this.muzzleVelocityKmS = 155;
    this.energyDrainMj = 128;
    this.heatGeneratedKj = 39;
    this.effectiveRangeKm = 5850;
...
module.exports = { SingularityLauncherOverchargedCapacitorWeapon };
