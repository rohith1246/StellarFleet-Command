/**
 * SingularityLauncherSpinalMountWeapon.js - Naval Weapon Battery Simulation: SingularityLauncher mounted in SpinalMount.
 */

class SingularityLauncherSpinalMountWeapon {
  constructor(firingMount = 'SpinalMount', options = {}) {
    this.weaponName = 'SingularityLauncher';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 750;
...
module.exports = { SingularityLauncherSpinalMountWeapon };
