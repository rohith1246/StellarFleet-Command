/**
 * SingularityLauncherTurretTripleWeapon.js - Naval Weapon Battery Simulation: SingularityLauncher mounted in TurretTriple.
 */

class SingularityLauncherTurretTripleWeapon {
...
module.exports = { SingularityLauncherTurretTripleWeapon };
