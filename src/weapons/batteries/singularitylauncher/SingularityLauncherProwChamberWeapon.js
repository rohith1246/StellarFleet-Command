/**
 * SingularityLauncherProwChamberWeapon.js - Naval Weapon Battery Simulation: SingularityLauncher mounted in ProwChamber.
 */

class SingularityLauncherProwChamberWeapon {
...
module.exports = { SingularityLauncherProwChamberWeapon };
