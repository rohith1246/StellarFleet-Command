/**
 * SingularityLauncherTurretDualWeapon.js - Naval Weapon Battery Simulation: SingularityLauncher mounted in TurretDual.
 */

class SingularityLauncherTurretDualWeapon {
  constructor(firingMount = 'TurretDual', options = {}) {
    this.weaponName = 'SingularityLauncher';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 775;
...
module.exports = { SingularityLauncherTurretDualWeapon };
