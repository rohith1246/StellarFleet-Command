/**
 * SingularityLauncherContinuousBeamMountWeapon.js - Naval Weapon Battery Simulation: SingularityLauncher mounted in ContinuousBeamMount.
 */

class SingularityLauncherContinuousBeamMountWeapon {
  constructor(firingMount = 'ContinuousBeamMount', options = {}) {
    this.weaponName = 'SingularityLauncher';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 1075;
    this.rateOfFireRpm = 18;
    this.muzzleVelocityKmS = 155;
    this.energyDrainMj = 134;
    this.heatGeneratedKj = 23;
    this.effectiveRangeKm = 6050;
...
module.exports = { SingularityLauncherContinuousBeamMountWeapon };
