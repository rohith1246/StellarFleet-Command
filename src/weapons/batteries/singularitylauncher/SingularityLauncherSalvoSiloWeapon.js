/**
 * SingularityLauncherSalvoSiloWeapon.js - Naval Weapon Battery Simulation: SingularityLauncher mounted in SalvoSilo.
 */

class SingularityLauncherSalvoSiloWeapon {
  constructor(firingMount = 'SalvoSilo', options = {}) {
    this.weaponName = 'SingularityLauncher';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 1100;
    this.rateOfFireRpm = 24;
    this.muzzleVelocityKmS = 155;
    this.energyDrainMj = 137;
    this.heatGeneratedKj = 31;
    this.effectiveRangeKm = 6150;
...
module.exports = { SingularityLauncherSalvoSiloWeapon };
