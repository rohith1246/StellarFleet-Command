/**
 * SingularityLauncherDorsalHardpointWeapon.js - Naval Weapon Battery Simulation: SingularityLauncher mounted in DorsalHardpoint.
 */

class SingularityLauncherDorsalHardpointWeapon {
  constructor(firingMount = 'DorsalHardpoint', options = {}) {
    this.weaponName = 'SingularityLauncher';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 900;
...
module.exports = { SingularityLauncherDorsalHardpointWeapon };
