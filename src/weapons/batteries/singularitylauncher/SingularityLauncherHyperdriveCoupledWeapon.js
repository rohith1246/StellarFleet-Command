/**
 * SingularityLauncherHyperdriveCoupledWeapon.js - Naval Weapon Battery Simulation: SingularityLauncher mounted in HyperdriveCoupled.
 */

class SingularityLauncherHyperdriveCoupledWeapon {
  constructor(firingMount = 'HyperdriveCoupled', options = {}) {
    this.weaponName = 'SingularityLauncher';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 1125;
    this.rateOfFireRpm = 30;
    this.muzzleVelocityKmS = 155;
    this.energyDrainMj = 140;
    this.heatGeneratedKj = 39;
    this.effectiveRangeKm = 6250;
...
module.exports = { SingularityLauncherHyperdriveCoupledWeapon };
