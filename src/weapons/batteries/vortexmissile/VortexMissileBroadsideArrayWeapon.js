/**
 * VortexMissileBroadsideArrayWeapon.js - Naval Weapon Battery Simulation: VortexMissile mounted in BroadsideArray.
 */

class VortexMissileBroadsideArrayWeapon {
  constructor(firingMount = 'BroadsideArray', options = {}) {
    ...
    this.energyDrainMj = 84;
    this.heatGeneratedKj = 39;
    this.effectiveRangeKm = 4050;
...
module.exports = { VortexMissileBroadsideArrayWeapon };
