/**
 * VortexMissileDorsalHardpointWeapon.js - Naval Weapon Battery Simulation: VortexMissile mounted in DorsalHardpoint.
 */

class VortexMissileDorsalHardpointWeapon {
  constructor(firingMount = 'DorsalHardpoint', options = {}) {
    this.weaponName = 'VortexMissile';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 740;
...
module.exports = { VortexMissileDorsalHardpointWeapon };
