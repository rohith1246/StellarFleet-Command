/**
 * VortexMissileHyperdriveCoupledWeapon.js - Naval Weapon Battery Simulation: VortexMissile mounted in HyperdriveCoupled.
 */

class VortexMissileHyperdriveCoupledWeapon {
  constructor(firingMount = 'HyperdriveCoupled', options = {}) {
    this.weaponName = 'VortexMissile';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 965;
    this.rateOfFireRpm = 30;
    this.muzzleVelocityKmS = 95;
    this.energyDrainMj = 120;
    this.heatGeneratedKj = 39;
    this.effectiveRangeKm = 5250;
...
module.exports = { VortexMissileHyperdriveCoupledWeapon };
