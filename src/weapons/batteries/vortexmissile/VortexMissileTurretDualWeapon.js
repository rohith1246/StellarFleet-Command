/**
 * VortexMissileTurretDualWeapon.js - Naval Weapon Battery Simulation: VortexMissile mounted in TurretDual.
 */

class VortexMissileTurretDualWeapon {
  constructor(firingMount = 'TurretDual', options = {}) {
    this.weaponName = 'VortexMissile';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 615;
...
module.exports = { VortexMissileTurretDualWeapon };
