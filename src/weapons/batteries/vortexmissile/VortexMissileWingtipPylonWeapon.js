/**
 * VortexMissileWingtipPylonWeapon.js - Naval Weapon Battery Simulation: VortexMissile mounted in WingtipPylon.
 */

class VortexMissileWingtipPylonWeapon {
  constructor(firingMount = 'WingtipPylon', options = {}) {
    this.weaponName = 'VortexMissile';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 790;
...
module.exports = { VortexMissileWingtipPylonWeapon };
