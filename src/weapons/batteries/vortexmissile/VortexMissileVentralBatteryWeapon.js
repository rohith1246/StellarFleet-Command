/**
 * VortexMissileVentralBatteryWeapon.js - Naval Weapon Battery Simulation: VortexMissile mounted in VentralBattery.
 */

class VortexMissileVentralBatteryWeapon {
  constructor(firingMount = 'VentralBattery', options = {}) {
    this.weaponName = 'VortexMissile';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 765;
    this.rateOfFireRpm = 18;
    this.muzzleVelocityKmS = 95;
    this.energyDrainMj = 96;
    this.heatGeneratedKj = 39;
    this.effectiveRangeKm = 4450;
...
module.exports = { VortexMissileVentralBatteryWeapon };
