/**
 * VortexMissileProwChamberWeapon.js - Naval Weapon Battery Simulation: VortexMissile mounted in ProwChamber.
 */

class VortexMissileProwChamberWeapon {
...
module.exports = { VortexMissileProwChamberWeapon };
