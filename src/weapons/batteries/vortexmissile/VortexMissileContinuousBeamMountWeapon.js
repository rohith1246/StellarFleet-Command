/**
 * VortexMissileContinuousBeamMountWeapon.js - Naval Weapon Battery Simulation: VortexMissile mounted in ContinuousBeamMount.
 */

class VortexMissileContinuousBeamMountWeapon {
  constructor(firingMount = 'ContinuousBeamMount', options = {}) {
    this.weaponName = 'VortexMissile';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 915;
    this.rateOfFireRpm = 18;
    this.muzzleVelocityKmS = 95;
    this.energyDrainMj = 114;
    this.heatGeneratedKj = 23;
    this.effectiveRangeKm = 5050;
...
module.exports = { VortexMissileContinuousBeamMountWeapon };
