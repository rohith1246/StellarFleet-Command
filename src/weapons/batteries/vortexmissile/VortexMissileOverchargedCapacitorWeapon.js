/**
 * VortexMissileOverchargedCapacitorWeapon.js - Naval Weapon Battery Simulation: VortexMissile mounted in OverchargedCapacitor.
 */

class VortexMissileOverchargedCapacitorWeapon {
  constructor(firingMount = 'OverchargedCapacitor', options = {}) {
    this.weaponName = 'VortexMissile';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 865;
    this.rateOfFireRpm = 42;
    this.muzzleVelocityKmS = 95;
    this.energyDrainMj = 108;
    this.heatGeneratedKj = 39;
    this.effectiveRangeKm = 4850;
...
module.exports = { VortexMissileOverchargedCapacitorWeapon };
