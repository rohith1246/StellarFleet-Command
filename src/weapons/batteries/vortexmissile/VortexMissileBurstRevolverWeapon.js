/**
 * VortexMissileBurstRevolverWeapon.js - Naval Weapon Battery Simulation: VortexMissile mounted in BurstRevolver.
 */

class VortexMissileBurstRevolverWeapon {
  constructor(firingMount = 'BurstRevolver', options = {}) {
    this.weaponName = 'VortexMissile';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 890;
    this.rateOfFireRpm = 12;
    this.muzzleVelocityKmS = 95;
    this.energyDrainMj = 111;
    this.heatGeneratedKj = 15;
    this.effectiveRangeKm = 4950;
...
module.exports = { VortexMissileBurstRevolverWeapon };
