/**
 * VortexMissileSpinalMountWeapon.js - Naval Weapon Battery Simulation: VortexMissile mounted in SpinalMount.
 */

class VortexMissileSpinalMountWeapon {
  constructor(firingMount = 'SpinalMount', options = {}) {
    this.weaponName = 'VortexMissile';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 590;
    this.rateOfFireRpm = 12;
    this.muzzleVelocityKmS = 95;
    this.energyDrainMj = 75;
...
module.exports = { VortexMissileSpinalMountWeapon };
