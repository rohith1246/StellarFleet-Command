/**
 * VortexMissileTurretTripleWeapon.js - Naval Weapon Battery Simulation: VortexMissile mounted in TurretTriple.
 */

class VortexMissileTurretTripleWeapon {
  constructor(firingMount = 'TurretTriple', options = {}) {
    this.weaponName = 'VortexMissile';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 640;
    this.rateOfFireRpm = 24;
    this.muzzleVelocityKmS = 95;
    this.energyDrainMj = 81;
    this.heatGeneratedKj = 31;
    this.effectiveRangeKm = 3950;
...
module.exports = { VortexMissileTurretTripleWeapon };
