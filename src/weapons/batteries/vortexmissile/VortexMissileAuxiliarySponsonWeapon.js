/**
 * VortexMissileAuxiliarySponsonWeapon.js - Naval Weapon Battery Simulation: VortexMissile mounted in AuxiliarySponson.
 */

class VortexMissileAuxiliarySponsonWeapon {
  constructor(firingMount = 'AuxiliarySponson', options = {}) {
    this.weaponName = 'VortexMissile';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 840;
    this.rateOfFireRpm = 36;
    this.muzzleVelocityKmS = 95;
    this.energyDrainMj = 105;
    this.heatGeneratedKj = 31;
    this.effectiveRangeKm = 4750;
...
module.exports = { VortexMissileAuxiliarySponsonWeapon };
