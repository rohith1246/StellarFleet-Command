/**
 * VortexMissileSublightPodWeapon.js - Naval Weapon Battery Simulation: VortexMissile mounted in SublightPod.
 */

class VortexMissileSublightPodWeapon {
  constructor(firingMount = 'SublightPod', options = {}) {
    this.weaponName = 'VortexMissile';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 815;
    this.rateOfFireRpm = 30;
    this.muzzleVelocityKmS = 95;
    this.energyDrainMj = 102;
    this.heatGeneratedKj = 23;
    this.effectiveRangeKm = 4650;
...
module.exports = { VortexMissileSublightPodWeapon };
