/**
 * VortexMissileSalvoSiloWeapon.js - Naval Weapon Battery Simulation: VortexMissile mounted in SalvoSilo.
 */

class VortexMissileSalvoSiloWeapon {
  constructor(firingMount = 'SalvoSilo', options = {}) {
    this.weaponName = 'VortexMissile';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 940;
...
module.exports = { VortexMissileSalvoSiloWeapon };
