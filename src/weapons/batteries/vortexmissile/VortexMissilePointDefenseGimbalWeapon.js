/**
 * VortexMissilePointDefenseGimbalWeapon.js - Naval Weapon Battery Simulation: VortexMissile mounted in PointDefenseGimbal.
 */

class VortexMissilePointDefenseGimbalWeapon {
  constructor(firingMount = 'PointDefenseGimbal', options = {}) {
    this.weaponName = 'VortexMissile';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 690;
    this.rateOfFireRpm = 36;
    this.muzzleVelocityKmS = 95;
    this.energyDrainMj = 87;
    this.heatGeneratedKj = 15;
    this.effectiveRangeKm = 4150;
...
module.exports = { VortexMissilePointDefenseGimbalWeapon };
