/**
 * NeutronBlasterHyperdriveCoupledWeapon.js - Naval Weapon Battery Simulation: NeutronBlaster mounted in HyperdriveCoupled.
 */

class NeutronBlasterHyperdriveCoupledWeapon {
  constructor(firingMount = 'HyperdriveCoupled', options = {}) {
    this.weaponName = 'NeutronBlaster';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 885;
    this.rateOfFireRpm = 30;
    this.muzzleVelocityKmS = 65;
    this.energyDrainMj = 110;
...
module.exports = { NeutronBlasterHyperdriveCoupledWeapon };
