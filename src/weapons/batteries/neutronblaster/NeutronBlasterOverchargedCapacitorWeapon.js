/**
 * NeutronBlasterOverchargedCapacitorWeapon.js - Naval Weapon Battery Simulation: NeutronBlaster mounted in OverchargedCapacitor.
 */

class NeutronBlasterOverchargedCapacitorWeapon {
  constructor(firingMount = 'OverchargedCapacitor', options = {}) {
    this.weaponName = 'NeutronBlaster';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 785;
    this.rateOfFireRpm = 42;
    this.muzzleVelocityKmS = 65;
    this.energyDrainMj = 98;
    this.heatGeneratedKj = 39;
    this.effectiveRangeKm = 4350;
...
module.exports = { NeutronBlasterOverchargedCapacitorWeapon };
