/**
 * NeutronBlasterSublightPodWeapon.js - Naval Weapon Battery Simulation: NeutronBlaster mounted in SublightPod.
 */

class NeutronBlasterSublightPodWeapon {
...
module.exports = { NeutronBlasterSublightPodWeapon };
