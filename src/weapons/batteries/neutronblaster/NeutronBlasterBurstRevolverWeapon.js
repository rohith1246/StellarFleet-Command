/**
 * NeutronBlasterBurstRevolverWeapon.js - Naval Weapon Battery Simulation: NeutronBlaster mounted in BurstRevolver.
 */

class NeutronBlasterBurstRevolverWeapon {
...
module.exports = { NeutronBlasterBurstRevolverWeapon };
