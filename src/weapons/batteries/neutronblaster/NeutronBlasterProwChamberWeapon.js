/**
 * NeutronBlasterProwChamberWeapon.js - Naval Weapon Battery Simulation: NeutronBlaster mounted in ProwChamber.
 */

class NeutronBlasterProwChamberWeapon {
...
module.exports = { NeutronBlasterProwChamberWeapon };
