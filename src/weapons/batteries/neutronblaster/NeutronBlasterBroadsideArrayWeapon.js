/**
 * NeutronBlasterBroadsideArrayWeapon.js - Naval Weapon Battery Simulation: NeutronBlaster mounted in BroadsideArray.
 */

class NeutronBlasterBroadsideArrayWeapon {
...
module.exports = { NeutronBlasterBroadsideArrayWeapon };
