/**
 * NeutronBlasterVentralBatteryWeapon.js - Naval Weapon Battery Simulation: NeutronBlaster mounted in VentralBattery.
 */

class NeutronBlasterVentralBatteryWeapon {
  constructor(firingMount = 'VentralBattery', options = {}) {
    this.weaponName = 'NeutronBlaster';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 685;
    this.rateOfFireRpm = 18;
    this.muzzleVelocityKmS = 65;
    this.energyDrainMj = 86;
...
module.exports = { NeutronBlasterVentralBatteryWeapon };
