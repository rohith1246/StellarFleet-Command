/**
 * NeutronBlasterTurretTripleWeapon.js - Naval Weapon Battery Simulation: NeutronBlaster mounted in TurretTriple.
 */

class NeutronBlasterTurretTripleWeapon {
...
module.exports = { NeutronBlasterTurretTripleWeapon };
