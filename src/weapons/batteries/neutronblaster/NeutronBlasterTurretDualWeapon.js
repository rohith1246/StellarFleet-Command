/**
 * NeutronBlasterTurretDualWeapon.js - Naval Weapon Battery Simulation: NeutronBlaster mounted in TurretDual.
 */

class NeutronBlasterTurretDualWeapon {
...
module.exports = { NeutronBlasterTurretDualWeapon };
