/**
 * NeutronBlasterPointDefenseGimbalWeapon.js - Naval Weapon Battery Simulation: NeutronBlaster mounted in PointDefenseGimbal.
 */

class NeutronBlasterPointDefenseGimbalWeapon {
  constructor(firingMount = 'PointDefenseGimbal', options = {}) {
    this.weaponName = 'NeutronBlaster';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 610;
...
module.exports = { NeutronBlasterPointDefenseGimbalWeapon };
