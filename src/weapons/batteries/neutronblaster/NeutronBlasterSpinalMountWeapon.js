/**
 * NeutronBlasterSpinalMountWeapon.js - Naval Weapon Battery Simulation: NeutronBlaster mounted in SpinalMount.
 */

class NeutronBlasterSpinalMountWeapon {
  constructor(firingMount = 'SpinalMount', options = {}) {
    this.weaponName = 'NeutronBlaster';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 510;
...
module.exports = { NeutronBlasterSpinalMountWeapon };
