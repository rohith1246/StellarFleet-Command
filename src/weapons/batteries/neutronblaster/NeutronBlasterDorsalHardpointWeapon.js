/**
 * NeutronBlasterDorsalHardpointWeapon.js - Naval Weapon Battery Simulation: NeutronBlaster mounted in DorsalHardpoint.
 */

class NeutronBlasterDorsalHardpointWeapon {
  constructor(firingMount = 'DorsalHardpoint', options = {}) {
    this.weaponName = 'NeutronBlaster';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 660;
...
module.exports = { NeutronBlasterDorsalHardpointWeapon };
