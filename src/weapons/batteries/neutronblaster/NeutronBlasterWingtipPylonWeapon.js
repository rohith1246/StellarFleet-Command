/**
 * NeutronBlasterWingtipPylonWeapon.js - Naval Weapon Battery Simulation: NeutronBlaster mounted in WingtipPylon.
 */

class NeutronBlasterWingtipPylonWeapon {
...
module.exports = { NeutronBlasterWingtipPylonWeapon };
