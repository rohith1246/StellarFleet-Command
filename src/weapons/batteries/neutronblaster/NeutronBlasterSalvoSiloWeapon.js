/**
 * NeutronBlasterSalvoSiloWeapon.js - Naval Weapon Battery Simulation: NeutronBlaster mounted in SalvoSilo.
 */

class NeutronBlasterSalvoSiloWeapon {
...
module.exports = { NeutronBlasterSalvoSiloWeapon };
