/**
 * NeutronBlasterContinuousBeamMountWeapon.js - Naval Weapon Battery Simulation: NeutronBlaster mounted in ContinuousBeamMount.
 */

class NeutronBlasterContinuousBeamMountWeapon {
  constructor(firingMount = 'ContinuousBeamMount', options = {}) {
    this.weaponName = 'NeutronBlaster';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 835;
    this.rateOfFireRpm = 18;
    this.muzzleVelocityKmS = 65;
    this.energyDrainMj = 104;
    this.heatGeneratedKj = 23;
    this.effectiveRangeKm = 4550;
...
module.exports = { NeutronBlasterContinuousBeamMountWeapon };
