/**
 * ArcEmitterWingtipPylonWeapon.js - Naval Weapon Battery Simulation: ArcEmitter mounted in WingtipPylon.
 */

class ArcEmitterWingtipPylonWeapon {
  constructor(firingMount = 'WingtipPylon', options = {}) {
    this.weaponName = 'ArcEmitter';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 830;
...
module.exports = { ArcEmitterWingtipPylonWeapon };
