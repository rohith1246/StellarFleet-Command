/**
 * ArcEmitterSpinalMountWeapon.js - Naval Weapon Battery Simulation: ArcEmitter mounted in SpinalMount.
 */

class ArcEmitterSpinalMountWeapon {
  constructor(firingMount = 'SpinalMount', options = {}) {
    this.weaponName = 'ArcEmitter';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 630;
...
module.exports = { ArcEmitterSpinalMountWeapon };
