/**
 * ArcEmitterOverchargedCapacitorWeapon.js - Naval Weapon Battery Simulation: ArcEmitter mounted in OverchargedCapacitor.
 */

class ArcEmitterOverchargedCapacitorWeapon {
  constructor(firingMount = 'OverchargedCapacitor', options = {}) {
    this.weaponName = 'ArcEmitter';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 905;
    this.rateOfFireRpm = 42;
    this.muzzleVelocityKmS = 110;
    this.energyDrainMj = 113;
    this.heatGeneratedKj = 39;
    this.effectiveRangeKm = 5100;
...
module.exports = { ArcEmitterOverchargedCapacitorWeapon };
