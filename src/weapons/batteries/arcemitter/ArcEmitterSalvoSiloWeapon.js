/**
 * ArcEmitterSalvoSiloWeapon.js - Naval Weapon Battery Simulation: ArcEmitter mounted in SalvoSilo.
 */

class ArcEmitterSalvoSiloWeapon {
  constructor(firingMount = 'SalvoSilo', options = {}) {
    this.weaponName = 'ArcEmitter';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 980;
...
module.exports = { ArcEmitterSalvoSiloWeapon };
