/**
 * ArcEmitterBroadsideArrayWeapon.js - Naval Weapon Battery Simulation: ArcEmitter mounted in BroadsideArray.
 */

class ArcEmitterBroadsideArrayWeapon {
...
module.exports = { ArcEmitterBroadsideArrayWeapon };
