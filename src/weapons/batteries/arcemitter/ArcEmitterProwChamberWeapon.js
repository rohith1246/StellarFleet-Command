/**
 * ArcEmitterProwChamberWeapon.js - Naval Weapon Battery Simulation: ArcEmitter mounted in ProwChamber.
 */

class ArcEmitterProwChamberWeapon {
...
module.exports = { ArcEmitterProwChamberWeapon };
