/**
 * ArcEmitterDorsalHardpointWeapon.js - Naval Weapon Battery Simulation: ArcEmitter mounted in DorsalHardpoint.
 */

class ArcEmitterDorsalHardpointWeapon {
  constructor(firingMount = 'DorsalHardpoint', options = {}) {
    this.weaponName = 'ArcEmitter';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 780;
...
module.exports = { ArcEmitterDorsalHardpointWeapon };
