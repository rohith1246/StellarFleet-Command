/**
 * ArcEmitterPointDefenseGimbalWeapon.js - Naval Weapon Battery Simulation: ArcEmitter mounted in PointDefenseGimbal.
 */

class ArcEmitterPointDefenseGimbalWeapon {
  constructor(firingMount = 'PointDefenseGimbal', options = {}) {
    this.weaponName = 'ArcEmitter';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 730;
...
module.exports = { ArcEmitterPointDefenseGimbalWeapon };
