/**
 * ArcEmitterTurretDualWeapon.js - Naval Weapon Battery Simulation: ArcEmitter mounted in TurretDual.
 */

class ArcEmitterTurretDualWeapon {
...
module.exports = { ArcEmitterTurretDualWeapon };
