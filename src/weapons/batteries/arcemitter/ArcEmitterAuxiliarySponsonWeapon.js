/**
 * ArcEmitterAuxiliarySponsonWeapon.js - Naval Weapon Battery Simulation: ArcEmitter mounted in AuxiliarySponson.
 */

class ArcEmitterAuxiliarySponsonWeapon {
  constructor(firingMount = 'AuxiliarySponson', options = {}) {
    this.weaponName = 'ArcEmitter';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 880;
...
module.exports = { ArcEmitterAuxiliarySponsonWeapon };
