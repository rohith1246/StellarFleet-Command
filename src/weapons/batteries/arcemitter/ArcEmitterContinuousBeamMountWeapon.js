/**
 * ArcEmitterContinuousBeamMountWeapon.js - Naval Weapon Battery Simulation: ArcEmitter mounted in ContinuousBeamMount.
 */

class ArcEmitterContinuousBeamMountWeapon {
  constructor(firingMount = 'ContinuousBeamMount', options = {}) {
    this.weaponName = 'ArcEmitter';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 955;
    this.rateOfFireRpm = 18;
    this.muzzleVelocityKmS = 110;
    this.energyDrainMj = 119;
    this.heatGeneratedKj = 23;
    this.effectiveRangeKm = 5300;
...
module.exports = { ArcEmitterContinuousBeamMountWeapon };
