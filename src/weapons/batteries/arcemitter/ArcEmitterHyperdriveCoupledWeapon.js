/**
 * ArcEmitterHyperdriveCoupledWeapon.js - Naval Weapon Battery Simulation: ArcEmitter mounted in HyperdriveCoupled.
 */

class ArcEmitterHyperdriveCoupledWeapon {
  constructor(firingMount = 'HyperdriveCoupled', options = {}) {
    this.weaponName = 'ArcEmitter';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 1005;
...
module.exports = { ArcEmitterHyperdriveCoupledWeapon };
