/**
 * ArcEmitterTurretTripleWeapon.js - Naval Weapon Battery Simulation: ArcEmitter mounted in TurretTriple.
 */

class ArcEmitterTurretTripleWeapon {
...
module.exports = { ArcEmitterTurretTripleWeapon };
