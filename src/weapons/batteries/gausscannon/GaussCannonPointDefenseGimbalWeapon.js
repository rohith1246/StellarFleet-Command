/**
 * GaussCannonPointDefenseGimbalWeapon.js - Naval Weapon Battery Simulation: GaussCannon mounted in PointDefenseGimbal.
 */

class GaussCannonPointDefenseGimbalWeapon {
  constructor(firingMount = 'PointDefenseGimbal', options = {}) {
    this.weaponName = 'GaussCannon';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 530;
...
module.exports = { GaussCannonPointDefenseGimbalWeapon };
