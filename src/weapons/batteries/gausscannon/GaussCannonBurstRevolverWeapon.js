/**
 * GaussCannonBurstRevolverWeapon.js - Naval Weapon Battery Simulation: GaussCannon mounted in BurstRevolver.
 */

class GaussCannonBurstRevolverWeapon {
...
module.exports = { GaussCannonBurstRevolverWeapon };
