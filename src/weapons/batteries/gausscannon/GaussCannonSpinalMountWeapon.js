/**
 * GaussCannonSpinalMountWeapon.js - Naval Weapon Battery Simulation: GaussCannon mounted in SpinalMount.
 */

class GaussCannonSpinalMountWeapon {
...
module.exports = { GaussCannonSpinalMountWeapon };
