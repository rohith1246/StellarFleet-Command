/**
 * GaussCannonContinuousBeamMountWeapon.js - Naval Weapon Battery Simulation: GaussCannon mounted in ContinuousBeamMount.
 */

class GaussCannonContinuousBeamMountWeapon {
  constructor(firingMount = 'ContinuousBeamMount', options = {}) {
    this.weaponName = 'GaussCannon';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 755;
    this.rateOfFireRpm = 18;
    this.muzzleVelocityKmS = 155;
    this.energyDrainMj = 94;
...
module.exports = { GaussCannonContinuousBeamMountWeapon };
