/**
 * GaussCannonSalvoSiloWeapon.js - Naval Weapon Battery Simulation: GaussCannon mounted in SalvoSilo.
 */

class GaussCannonSalvoSiloWeapon {
...
module.exports = { GaussCannonSalvoSiloWeapon };
