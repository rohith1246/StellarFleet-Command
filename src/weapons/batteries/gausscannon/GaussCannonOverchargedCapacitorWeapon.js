/**
 * GaussCannonOverchargedCapacitorWeapon.js - Naval Weapon Battery Simulation: GaussCannon mounted in OverchargedCapacitor.
 */

class GaussCannonOverchargedCapacitorWeapon {
  constructor(firingMount = 'OverchargedCapacitor', options = {}) {
    this.weaponName = 'GaussCannon';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 705;
    this.rateOfFireRpm = 42;
    this.muzzleVelocityKmS = 155;
    this.energyDrainMj = 88;
    this.heatGeneratedKj = 39;
    this.effectiveRangeKm = 3850;
...
module.exports = { GaussCannonOverchargedCapacitorWeapon };
