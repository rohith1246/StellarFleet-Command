/**
 * GaussCannonTurretTripleWeapon.js - Naval Weapon Battery Simulation: GaussCannon mounted in TurretTriple.
 */

class GaussCannonTurretTripleWeapon {
...
module.exports = { GaussCannonTurretTripleWeapon };
