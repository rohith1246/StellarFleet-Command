/**
 * GaussCannonProwChamberWeapon.js - Naval Weapon Battery Simulation: GaussCannon mounted in ProwChamber.
 */

class GaussCannonProwChamberWeapon {
...
module.exports = { GaussCannonProwChamberWeapon };
