/**
 * GaussCannonHyperdriveCoupledWeapon.js - Naval Weapon Battery Simulation: GaussCannon mounted in HyperdriveCoupled.
 */

class GaussCannonHyperdriveCoupledWeapon {
...
module.exports = { GaussCannonHyperdriveCoupledWeapon };
