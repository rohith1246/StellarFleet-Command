/**
 * GaussCannonTurretDualWeapon.js - Naval Weapon Battery Simulation: GaussCannon mounted in TurretDual.
 */

class GaussCannonTurretDualWeapon {
...
module.exports = { GaussCannonTurretDualWeapon };
