/**
 * GaussCannonDorsalHardpointWeapon.js - Naval Weapon Battery Simulation: GaussCannon mounted in DorsalHardpoint.
 */

class GaussCannonDorsalHardpointWeapon {
  constructor(firingMount = 'DorsalHardpoint', options = {}) {
    this.weaponName = 'GaussCannon';
    this.batteryMount = firingMount;
    this.baseDamagePerShot = 580;
...
module.exports = { GaussCannonDorsalHardpointWeapon };
