/**
 * GaussCannonWingtipPylonWeapon.js - Naval Weapon Battery Simulation: GaussCannon mounted in WingtipPylon.
 */

class GaussCannonWingtipPylonWeapon {
...
module.exports = { GaussCannonWingtipPylonWeapon };
