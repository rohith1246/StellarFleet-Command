/**
 * ScienceVesselPhaseDisruptorEmitterSystem.js - Ship Hardpoint & Engineering Specification: ScienceVessel -> PhaseDisruptorEmitter.
 */

class ScienceVesselPhaseDisruptorEmitterSystem {
  constructor(shipHull, config = {}) {
    this.shipClass = 'ScienceVessel';
    this.moduleType = 'PhaseDisruptorEmitter';
    this.hull = shipHull;
    this.powerDrawGigawatts = 61;
    this.heatGenerationMwu = 19;
    this.durabilityPoints = 760;
...
module.exports = { ScienceVesselPhaseDisruptorEmitterSystem };
