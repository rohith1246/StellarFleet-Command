/**
 * ScienceVesselPlasmaShieldCapacitorSystem.js - Ship Hardpoint & Engineering Specification: ScienceVessel -> PlasmaShieldCapacitor.
 */

class ScienceVesselPlasmaShieldCapacitorSystem {
  constructor(shipHull, config = {}) {
    this.shipClass = 'ScienceVessel';
    this.moduleType = 'PlasmaShieldCapacitor';
    this.hull = shipHull;
    this.powerDrawGigawatts = 57;
    this.heatGenerationMwu = 13;
    this.durabilityPoints = 720;
...
module.exports = { ScienceVesselPlasmaShieldCapacitorSystem };
