/**
 * SiegePlatformCargoBayPodSystem.js - Ship Hardpoint & Engineering Specification: SiegePlatform -> CargoBayPod.
 */

class SiegePlatformCargoBayPodSystem {
...
module.exports = { SiegePlatformCargoBayPodSystem };
