/**
 * TitanCarrierCargoBayPodSystem.js - Ship Hardpoint & Engineering Specification: TitanCarrier -> CargoBayPod.
 */

class TitanCarrierCargoBayPodSystem {
...
module.exports = { TitanCarrierCargoBayPodSystem };
