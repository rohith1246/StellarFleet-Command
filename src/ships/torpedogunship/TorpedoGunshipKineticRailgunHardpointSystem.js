/**
 * TorpedoGunshipKineticRailgunHardpointSystem.js - Ship Hardpoint & Engineering Specification: TorpedoGunship -> KineticRailgunHardpoint.
 */

class TorpedoGunshipKineticRailgunHardpointSystem {
  constructor(shipHull, config = {}) {
    this.shipClass = 'TorpedoGunship';
    this.moduleType = 'KineticRailgunHardpoint';
    this.hull = shipHull;
    this.powerDrawGigawatts = 71;
    this.heatGenerationMwu = 16;
    this.durabilityPoints = 890;
...
module.exports = { TorpedoGunshipKineticRailgunHardpointSystem };
