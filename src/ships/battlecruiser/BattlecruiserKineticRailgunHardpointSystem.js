/**
 * BattlecruiserKineticRailgunHardpointSystem.js - Ship Hardpoint & Engineering Specification: Battlecruiser -> KineticRailgunHardpoint.
 */

class BattlecruiserKineticRailgunHardpointSystem {
  constructor(shipHull, config = {}) {
    this.shipClass = 'Battlecruiser';
    this.moduleType = 'KineticRailgunHardpoint';
    this.hull = shipHull;
    this.powerDrawGigawatts = 31;
...
module.exports = { BattlecruiserKineticRailgunHardpointSystem };
