/**
 * StealthCorvetteSubspaceTachyonRadarSystem.js - Ship Hardpoint & Engineering Specification: StealthCorvette -> SubspaceTachyonRadar.
 */

class StealthCorvetteSubspaceTachyonRadarSystem {
  constructor(shipHull, config = {}) {
    this.shipClass = 'StealthCorvette';
    this.moduleType = 'SubspaceTachyonRadar';
    this.hull = shipHull;
    this.powerDrawGigawatts = 55;
    this.heatGenerationMwu = 13;
    this.durabilityPoints = 670;
...
module.exports = { StealthCorvetteSubspaceTachyonRadarSystem };
