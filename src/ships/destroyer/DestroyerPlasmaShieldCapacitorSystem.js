/**
 * DestroyerPlasmaShieldCapacitorSystem.js - Ship Hardpoint & Engineering Specification: Destroyer -> PlasmaShieldCapacitor.
 */

class DestroyerPlasmaShieldCapacitorSystem {
  constructor(shipHull, config = {}) {
    this.shipClass = 'Destroyer';
    this.moduleType = 'PlasmaShieldCapacitor';
    this.hull = shipHull;
    this.powerDrawGigawatts = 21;
    this.heatGenerationMwu = 13;
    this.durabilityPoints = 270;
...
module.exports = { DestroyerPlasmaShieldCapacitorSystem };
