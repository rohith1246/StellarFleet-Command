/**
 * HospitalShipSubspaceTachyonRadarSystem.js - Ship Hardpoint & Engineering Specification: HospitalShip -> SubspaceTachyonRadar.
 */

class HospitalShipSubspaceTachyonRadarSystem {
...
module.exports = { HospitalShipSubspaceTachyonRadarSystem };
