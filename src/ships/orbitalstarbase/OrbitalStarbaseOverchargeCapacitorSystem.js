/**
 * OrbitalStarbaseOverchargeCapacitorSystem.js - Ship Hardpoint & Engineering Specification: OrbitalStarbase -> OverchargeCapacitor.
 */

class OrbitalStarbaseOverchargeCapacitorSystem {
  constructor(shipHull, config = {}) {
    this.shipClass = 'OrbitalStarbase';
    this.moduleType = 'OverchargeCapacitor';
    this.hull = shipHull;
    this.powerDrawGigawatts = 105;
    this.heatGenerationMwu = 10;
    this.durabilityPoints = 1250;
...
module.exports = { OrbitalStarbaseOverchargeCapacitorSystem };
