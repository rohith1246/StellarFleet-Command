/**
 * OrbitalStarbaseTractorBeamEmitterSystem.js - Ship Hardpoint & Engineering Specification: OrbitalStarbase -> TractorBeamEmitter.
 */

class OrbitalStarbaseTractorBeamEmitterSystem {
  constructor(shipHull, config = {}) {
    this.shipClass = 'OrbitalStarbase';
    this.moduleType = 'TractorBeamEmitter';
    this.hull = shipHull;
    this.powerDrawGigawatts = 101;
    this.heatGenerationMwu = 19;
    this.durabilityPoints = 1210;
...
module.exports = { OrbitalStarbaseTractorBeamEmitterSystem };
