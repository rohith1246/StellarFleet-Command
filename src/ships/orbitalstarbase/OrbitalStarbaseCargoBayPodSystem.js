/**
 * OrbitalStarbaseCargoBayPodSystem.js - Ship Hardpoint & Engineering Specification: OrbitalStarbase -> CargoBayPod.
 */

class OrbitalStarbaseCargoBayPodSystem {
  constructor(shipHull, config = {}) {
    this.shipClass = 'OrbitalStarbase';
    this.moduleType = 'CargoBayPod';
    this.hull = shipHull;
    this.powerDrawGigawatts = 103;
    this.heatGenerationMwu = 22;
    this.durabilityPoints = 1230;
...
module.exports = { OrbitalStarbaseCargoBayPodSystem };
