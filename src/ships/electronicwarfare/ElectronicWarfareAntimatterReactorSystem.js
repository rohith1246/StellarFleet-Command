/**
 * ElectronicWarfareAntimatterReactorSystem.js - Ship Hardpoint & Engineering Specification: ElectronicWarfare -> AntimatterReactor.
 */

class ElectronicWarfareAntimatterReactorSystem {
  constructor(shipHull, config = {}) {
    this.shipClass = 'ElectronicWarfare';
    this.moduleType = 'AntimatterReactor';
    this.hull = shipHull;
    this.powerDrawGigawatts = 63;
    this.heatGenerationMwu = 10;
    this.durabilityPoints = 800;
...
module.exports = { ElectronicWarfareAntimatterReactorSystem };
