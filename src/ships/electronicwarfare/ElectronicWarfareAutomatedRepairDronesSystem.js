/**
 * ElectronicWarfareAutomatedRepairDronesSystem.js - Ship Hardpoint & Engineering Specification: ElectronicWarfare -> AutomatedRepairDrones.
 */

class ElectronicWarfareAutomatedRepairDronesSystem {
  constructor(shipHull, config = {}) {
    this.shipClass = 'ElectronicWarfare';
    this.moduleType = 'AutomatedRepairDrones';
    this.hull = shipHull;
    this.powerDrawGigawatts = 79;
    this.heatGenerationMwu = 19;
    this.durabilityPoints = 960;
...
module.exports = { ElectronicWarfareAutomatedRepairDronesSystem };
