/**
 * ElectronicWarfareTractorBeamEmitterSystem.js - Ship Hardpoint & Engineering Specification: ElectronicWarfare -> TractorBeamEmitter.
 */

class ElectronicWarfareTractorBeamEmitterSystem {
  constructor(shipHull, config = {}) {
    this.shipClass = 'ElectronicWarfare';
    this.moduleType = 'TractorBeamEmitter';
    this.hull = shipHull;
    this.powerDrawGigawatts = 89;
    this.heatGenerationMwu = 19;
    this.durabilityPoints = 1060;
...
module.exports = { ElectronicWarfareTractorBeamEmitterSystem };
