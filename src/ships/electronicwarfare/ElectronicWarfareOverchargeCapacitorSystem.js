/**
 * ElectronicWarfareOverchargeCapacitorSystem.js - Ship Hardpoint & Engineering Specification: ElectronicWarfare -> OverchargeCapacitor.
 */

class ElectronicWarfareOverchargeCapacitorSystem {
  constructor(shipHull, config = {}) {
    this.shipClass = 'ElectronicWarfare';
    this.moduleType = 'OverchargeCapacitor';
    this.hull = shipHull;
    this.powerDrawGigawatts = 93;
    this.heatGenerationMwu = 10;
    this.durabilityPoints = 1100;
...
module.exports = { ElectronicWarfareOverchargeCapacitorSystem };
