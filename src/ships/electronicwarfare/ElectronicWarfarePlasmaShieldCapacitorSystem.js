/**
 * ElectronicWarfarePlasmaShieldCapacitorSystem.js - Ship Hardpoint & Engineering Specification: ElectronicWarfare -> PlasmaShieldCapacitor.
 */

class ElectronicWarfarePlasmaShieldCapacitorSystem {
  constructor(shipHull, config = {}) {
    this.shipClass = 'ElectronicWarfare';
    this.moduleType = 'PlasmaShieldCapacitor';
    this.hull = shipHull;
    this.powerDrawGigawatts = 65;
    this.heatGenerationMwu = 13;
    this.durabilityPoints = 820;
...
module.exports = { ElectronicWarfarePlasmaShieldCapacitorSystem };
