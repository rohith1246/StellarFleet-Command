/**
 * FrigateTargetingMatrixSystem.js - Ship Hardpoint & Engineering Specification: Frigate -> TargetingMatrix.
 */

class FrigateTargetingMatrixSystem {
...
module.exports = { FrigateTargetingMatrixSystem };
