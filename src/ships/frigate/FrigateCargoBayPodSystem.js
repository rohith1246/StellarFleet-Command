/**
 * FrigateCargoBayPodSystem.js - Ship Hardpoint & Engineering Specification: Frigate -> CargoBayPod.
 */

class FrigateCargoBayPodSystem {
...
module.exports = { FrigateCargoBayPodSystem };
