/**
 * FrigateAntimatterReactorSystem.js - Ship Hardpoint & Engineering Specification: Frigate -> AntimatterReactor.
 */

class FrigateAntimatterReactorSystem {
  constructor(shipHull, config = {}) {
    this.shipClass = 'Frigate';
    this.moduleType = 'AntimatterReactor';
    this.hull = shipHull;
    this.powerDrawGigawatts = 15;
    this.heatGenerationMwu = 10;
    this.durabilityPoints = 200;
...
module.exports = { FrigateAntimatterReactorSystem };
