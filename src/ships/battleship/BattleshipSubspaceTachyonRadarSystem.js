/**
 * BattleshipSubspaceTachyonRadarSystem.js - Ship Hardpoint & Engineering Specification: Battleship -> SubspaceTachyonRadar.
 */

class BattleshipSubspaceTachyonRadarSystem {
...
module.exports = { BattleshipSubspaceTachyonRadarSystem };
