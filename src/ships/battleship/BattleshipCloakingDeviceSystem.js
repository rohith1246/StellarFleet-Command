/**
 * BattleshipCloakingDeviceSystem.js - Ship Hardpoint & Engineering Specification: Battleship -> CloakingDevice.
 */

class BattleshipCloakingDeviceSystem {
...
module.exports = { BattleshipCloakingDeviceSystem };
