/**
 * TurtleDefensiveWarpEscapeEmergencyDoctrine.js - Fleet Command Tactical AI Doctrine: TurtleDefensive -> WarpEscapeEmergency.
 */

class TurtleDefensiveWarpEscapeEmergencyDoctrine {
  constructor(fleetCommander, sensorRange = 50000) {
    this.doctrineName = 'TurtleDefensive';
    this.tacticName = 'WarpEscapeEmergency';
    this.commander = fleetCommander;
    this.sensorRange = sensorRange;
    this.aggressionFactor = 0.46;
  }
  ...
  evaluateBattlefield(hostileFleets, friendlyFleet) {
    ...
    return { action: 'CLOSE_DISTANCE_FORMATION', formation: 'TurtleDefensive', target: targetFleet };
  }
  ...
  execute(friendlyFleet, hostileFleets) {
    ...
    if (decision.action === 'ENGAGE_TACTICAL_MANOEUVRE') {
      ...
      friendlyFleet.repositionTowards(decision.target.pos, 'TurtleDefensive');
    }
    return decision;
  }
}

module.exports = { TurtleDefensiveWarpEscapeEmergencyDoctrine };
