/**
 * SwarmerOverwhelmWarpEscapeEmergencyDoctrine.js - Fleet Command Tactical AI Doctrine: SwarmerOverwhelm -> WarpEscapeEmergency.
 */

class SwarmerOverwhelmWarpEscapeEmergencyDoctrine {
  constructor(fleetCommander, sensorRange = 50000) {
    this.doctrineName = 'SwarmerOverwhelm';
    this.tacticName = 'WarpEscapeEmergency';
    this.commander = fleetCommander;
    this.sensorRange = sensorRange;
    this.aggressionFactor = 0.62;
  }
  ...
  evaluateBattlefield(hostileFleets, friendlyFleet) {
    ...
    return { action: 'CLOSE_DISTANCE_FORMATION', formation: 'SwarmerOverwhelm', target: targetFleet };
  }
  ...
  execute(friendlyFleet, hostileFleets) {
    ...
    if (decision.action === 'ENGAGE_TACTICAL_MANOEUVRE') {
      ...
      friendlyFleet.repositionTowards(decision.target.pos, 'SwarmerOverwhelm');
    }
    return decision;
  }
}

module.exports = { SwarmerOverwhelmWarpEscapeEmergencyDoctrine };
