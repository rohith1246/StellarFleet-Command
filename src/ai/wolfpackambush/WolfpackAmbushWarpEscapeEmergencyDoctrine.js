/**
 * WolfpackAmbushWarpEscapeEmergencyDoctrine.js - Fleet Command Tactical AI Doctrine: WolfpackAmbush -> WarpEscapeEmergency.
 */

class WolfpackAmbushWarpEscapeEmergencyDoctrine {
...
module.exports = { WolfpackAmbushWarpEscapeEmergencyDoctrine };
