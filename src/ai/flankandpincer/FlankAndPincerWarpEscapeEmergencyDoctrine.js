/**
 * FlankAndPincerWarpEscapeEmergencyDoctrine.js - Fleet Command Tactical AI Doctrine: FlankAndPincer -> WarpEscapeEmergency.
 */

class FlankAndPincerWarpEscapeEmergencyDoctrine {
...
module.exports = { FlankAndPincerWarpEscapeEmergencyDoctrine };
