/**
 * ElectronicSuppressionCoordinateVolleyDoctrine.js - Fleet Command Tactical AI Doctrine: ElectronicSuppression -> CoordinateVolley.
 */

class ElectronicSuppressionCoordinateVolleyDoctrine {
  constructor(fleetCommander, sensorRange = 50000) {
    this.doctrineName = 'ElectronicSuppression';
    this.tacticName = 'CoordinateVolley';
...
module.exports = { ElectronicSuppressionCoordinateVolleyDoctrine };
