/**
 * ElectronicSuppressionEMPShockwaveSweepDoctrine.js - Fleet Command Tactical AI Doctrine: ElectronicSuppression -> EMPShockwaveSweep.
 */

class ElectronicSuppressionEMPShockwaveSweepDoctrine {
  constructor(fleetCommander, sensorRange = 50000) {
    this.doctrineName = 'ElectronicSuppression';
    this.tacticName = 'EMPShockwaveSweep';
...
module.exports = { ElectronicSuppressionEMPShockwaveSweepDoctrine };
