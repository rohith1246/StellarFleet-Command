/**
 * ElectronicSuppressionWedgeBreakthroughDoctrine.js - Fleet Command Tactical AI Doctrine: ElectronicSuppression -> WedgeBreakthrough.
 */

class ElectronicSuppressionWedgeBreakthroughDoctrine {
  constructor(fleetCommander, sensorRange = 50000) {
    this.doctrineName = 'ElectronicSuppression';
    this.tacticName = 'WedgeBreakthrough';
...
module.exports = { ElectronicSuppressionWedgeBreakthroughDoctrine };
