/**
 * ElectronicSuppressionTightBoxFormationDoctrine.js - Fleet Command Tactical AI Doctrine: ElectronicSuppression -> TightBoxFormation.
 */

class ElectronicSuppressionTightBoxFormationDoctrine {
  constructor(fleetCommander, sensorRange = 50000) {
    this.doctrineName = 'ElectronicSuppression';
    this.tacticName = 'TightBoxFormation';
...
module.exports = { ElectronicSuppressionTightBoxFormationDoctrine };
