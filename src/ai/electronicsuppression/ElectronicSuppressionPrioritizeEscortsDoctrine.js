/**
 * ElectronicSuppressionPrioritizeEscortsDoctrine.js - Fleet Command Tactical AI Doctrine: ElectronicSuppression -> PrioritizeEscorts.
 */

class ElectronicSuppressionPrioritizeEscortsDoctrine {
  constructor(fleetCommander, sensorRange = 50000) {
    this.doctrineName = 'ElectronicSuppression';
    this.tacticName = 'PrioritizeEscorts';
...
module.exports = { ElectronicSuppressionPrioritizeEscortsDoctrine };
