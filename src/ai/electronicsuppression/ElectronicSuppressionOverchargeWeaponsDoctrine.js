/**
 * ElectronicSuppressionOverchargeWeaponsDoctrine.js - Fleet Command Tactical AI Doctrine: ElectronicSuppression -> OverchargeWeapons.
 */

class ElectronicSuppressionOverchargeWeaponsDoctrine {
  constructor(fleetCommander, sensorRange = 50000) {
    this.doctrineName = 'ElectronicSuppression';
    this.tacticName = 'OverchargeWeapons';
...
module.exports = { ElectronicSuppressionOverchargeWeaponsDoctrine };
