/**
 * ElectronicSuppressionRammingSpeedDoctrine.js - Fleet Command Tactical AI Doctrine: ElectronicSuppression -> RammingSpeed.
 */

class ElectronicSuppressionRammingSpeedDoctrine {
  constructor(fleetCommander, sensorRange = 50000) {
    this.doctrineName = 'ElectronicSuppression';
    this.tacticName = 'RammingSpeed';
...
module.exports = { ElectronicSuppressionRammingSpeedDoctrine };
