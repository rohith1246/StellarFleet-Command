/**
 * ElectronicSuppressionCoverRepairShipDoctrine.js - Fleet Command Tactical AI Doctrine: ElectronicSuppression -> CoverRepairShip.
 */

class ElectronicSuppressionCoverRepairShipDoctrine {
  constructor(fleetCommander, sensorRange = 50000) {
    this.doctrineName = 'ElectronicSuppression';
    this.tacticName = 'CoverRepairShip';
...
module.exports = { ElectronicSuppressionCoverRepairShipDoctrine };
