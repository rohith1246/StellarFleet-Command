/**
 * ElectronicSuppressionEvasiveSpiralDoctrine.js - Fleet Command Tactical AI Doctrine: ElectronicSuppression -> EvasiveSpiral.
 */

class ElectronicSuppressionEvasiveSpiralDoctrine {
  constructor(fleetCommander, sensorRange = 50000) {
    this.doctrineName = 'ElectronicSuppression';
    this.tacticName = 'EvasiveSpiral';
...
module.exports = { ElectronicSuppressionEvasiveSpiralDoctrine };
