/**
 * ElectronicSuppressionTargetCapitalFirstDoctrine.js - Fleet Command Tactical AI Doctrine: ElectronicSuppression -> TargetCapitalFirst.
 */

class ElectronicSuppressionTargetCapitalFirstDoctrine {
  constructor(fleetCommander, sensorRange = 50000) {
    this.doctrineName = 'ElectronicSuppression';
    this.tacticName = 'TargetCapitalFirst';
...
module.exports = { ElectronicSuppressionTargetCapitalFirstDoctrine };
