/**
 * ElectronicSuppressionBroadsideRotationDoctrine.js - Fleet Command Tactical AI Doctrine: ElectronicSuppression -> BroadsideRotation.
 */

class ElectronicSuppressionBroadsideRotationDoctrine {
  constructor(fleetCommander, sensorRange = 50000) {
    this.doctrineName = 'ElectronicSuppression';
    this.tacticName = 'BroadsideRotation';
...
module.exports = { ElectronicSuppressionBroadsideRotationDoctrine };
