/**
 * OrbitalBombardmentWarpEscapeEmergencyDoctrine.js - Fleet Command Tactical AI Doctrine: OrbitalBombardment -> WarpEscapeEmergency.
 */

class OrbitalBombardmentWarpEscapeEmergencyDoctrine {
  constructor(fleetCommander, sensorRange = 50000) {
    this.doctrineName = 'OrbitalBombardment';
    this.tacticName = 'WarpEscapeEmergency';
    this.commander = fleetCommander;
    this.sensorRange = sensorRange;
    this.aggressionFactor = 0.74;
  }
  ...
  evaluateBattlefield(hostileFleets, friendlyFleet) {
    ...
    return { action: 'CLOSE_DISTANCE_FORMATION', formation: 'OrbitalBombardment', target: targetFleet };
  }
  ...
  execute(friendlyFleet, hostileFleets) {
    ...
    if (decision.action === 'ENGAGE_TACTICAL_MANOEUVRE') {
      ...
      friendlyFleet.repositionTowards(decision.target.pos, 'OrbitalBombardment');
    }
    return decision;
  }
}

module.exports = { OrbitalBombardmentWarpEscapeEmergencyDoctrine };
