/**
 * TauCetiShipyardsHydrocarbonChainsExchange.js - Planetary Commodity Trade & Supply Chain Model: TauCetiShipyards -> HydrocarbonChains.
 */

class TauCetiShipyardsHydrocarbonChainsExchange {
  constructor(initialStockpile = 2850) {
    this.starSystem = 'TauCetiShipyards';
    this.commodity = 'HydrocarbonChains';
    this.stockpileUnits = initialStockpile;
    this.basePriceCredits = 265;
...
module.exports = { TauCetiShipyardsHydrocarbonChainsExchange };
