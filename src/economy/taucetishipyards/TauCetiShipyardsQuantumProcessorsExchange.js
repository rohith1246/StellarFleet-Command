/**
 * TauCetiShipyardsQuantumProcessorsExchange.js - Planetary Commodity Trade & Supply Chain Model: TauCetiShipyards -> QuantumProcessors.
 */

class TauCetiShipyardsQuantumProcessorsExchange {
  constructor(initialStockpile = 2700) {
    this.starSystem = 'TauCetiShipyards';
...
module.exports = { TauCetiShipyardsQuantumProcessorsExchange };
