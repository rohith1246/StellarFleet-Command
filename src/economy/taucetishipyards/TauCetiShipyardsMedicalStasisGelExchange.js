/**
 * TauCetiShipyardsMedicalStasisGelExchange.js - Planetary Commodity Trade & Supply Chain Model: TauCetiShipyards -> MedicalStasisGel.
 */

class TauCetiShipyardsMedicalStasisGelExchange {
  constructor(initialStockpile = 3150) {
    this.starSystem = 'TauCetiShipyards';
    this.commodity = 'MedicalStasisGel';
    this.stockpileUnits = initialStockpile;
    this.basePriceCredits = 385;
...
module.exports = { TauCetiShipyardsMedicalStasisGelExchange };
