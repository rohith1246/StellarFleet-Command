/**
 * TauCetiShipyardsTritiumFuelExchange.js - Planetary Commodity Trade & Supply Chain Model: TauCetiShipyards -> TritiumFuel.
 */

class TauCetiShipyardsTritiumFuelExchange {
  constructor(initialStockpile = 2450) {
    this.starSystem = 'TauCetiShipyards';
    this.commodity = 'TritiumFuel';
    this.stockpileUnits = initialStockpile;
    this.basePriceCredits = 105;
...
module.exports = { TauCetiShipyardsTritiumFuelExchange };
