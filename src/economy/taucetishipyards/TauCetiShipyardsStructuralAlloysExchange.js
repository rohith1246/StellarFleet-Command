/**
 * TauCetiShipyardsStructuralAlloysExchange.js - Planetary Commodity Trade & Supply Chain Model: TauCetiShipyards -> StructuralAlloys.
 */

class TauCetiShipyardsStructuralAlloysExchange {
  constructor(initialStockpile = 3050) {
    this.starSystem = 'TauCetiShipyards';
    this.commodity = 'StructuralAlloys';
    this.stockpileUnits = initialStockpile;
    this.basePriceCredits = 345;
...
module.exports = { TauCetiShipyardsStructuralAlloysExchange };
