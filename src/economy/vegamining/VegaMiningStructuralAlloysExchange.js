/**
 * VegaMiningStructuralAlloysExchange.js - Planetary Commodity Trade & Supply Chain Model: VegaMining -> StructuralAlloys.
 */

class VegaMiningStructuralAlloysExchange {
...
module.exports = { VegaMiningStructuralAlloysExchange };
