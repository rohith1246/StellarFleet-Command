/**
 * VegaMiningQuantumProcessorsExchange.js - Planetary Commodity Trade & Supply Chain Model: VegaMining -> QuantumProcessors.
 */

class VegaMiningQuantumProcessorsExchange {
  constructor(initialStockpile = 1900) {
...
module.exports = { VegaMiningQuantumProcessorsExchange };
