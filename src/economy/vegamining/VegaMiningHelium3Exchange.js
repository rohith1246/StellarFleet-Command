/**
 * VegaMiningHelium3Exchange.js - Planetary Commodity Trade & Supply Chain Model: VegaMining -> Helium3.
 */

class VegaMiningHelium3Exchange {
  constructor(initialStockpile = 1600) {
    this.starSystem = 'VegaMining';
    this.commodity = 'Helium3';
    this.stockpileUnits = initialStockpile;
    this.basePriceCredits = 65;
...
module.exports = { VegaMiningHelium3Exchange };
