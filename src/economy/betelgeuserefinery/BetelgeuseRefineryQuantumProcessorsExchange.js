/**
 * BetelgeuseRefineryQuantumProcessorsExchange.js - Planetary Commodity Trade & Supply Chain Model: BetelgeuseRefinery -> QuantumProcessors.
 */

class BetelgeuseRefineryQuantumProcessorsExchange {
  constructor(initialStockpile = 2100) {
...
module.exports = { BetelgeuseRefineryQuantumProcessorsExchange };
