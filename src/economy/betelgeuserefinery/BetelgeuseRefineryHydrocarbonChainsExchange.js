/**
 * BetelgeuseRefineryHydrocarbonChainsExchange.js - Planetary Commodity Trade & Supply Chain Model: BetelgeuseRefinery -> HydrocarbonChains.
 */

class BetelgeuseRefineryHydrocarbonChainsExchange {
  constructor(initialStockpile = 2250) {
...
module.exports = { BetelgeuseRefineryHydrocarbonChainsExchange };
