/**
 * BetelgeuseRefineryHyperdriveCoresExchange.js - Planetary Commodity Trade & Supply Chain Model: BetelgeuseRefinery -> HyperdriveCores.
 */

class BetelgeuseRefineryHyperdriveCoresExchange {
  constructor(initialStockpile = 2400) {
...
module.exports = { BetelgeuseRefineryHyperdriveCoresExchange };
