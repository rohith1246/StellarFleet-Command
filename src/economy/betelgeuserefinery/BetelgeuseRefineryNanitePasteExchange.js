/**
 * BetelgeuseRefineryNanitePasteExchange.js - Planetary Commodity Trade & Supply Chain Model: BetelgeuseRefinery -> NanitePaste.
 */

class BetelgeuseRefineryNanitePasteExchange {
...
module.exports = { BetelgeuseRefineryNanitePasteExchange };
