/**
 * BetelgeuseRefineryTritiumFuelExchange.js - Planetary Commodity Trade & Supply Chain Model: BetelgeuseRefinery -> TritiumFuel.
 */

class BetelgeuseRefineryTritiumFuelExchange {
  constructor(initialStockpile = 1850) {
    this.starSystem = 'BetelgeuseRefinery';
    this.commodity = 'TritiumFuel';
    this.stockpileUnits = initialStockpile;
    this.basePriceCredits = 90;
...
module.exports = { BetelgeuseRefineryTritiumFuelExchange };
