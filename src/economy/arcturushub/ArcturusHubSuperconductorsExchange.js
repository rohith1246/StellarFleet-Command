/**
 * ArcturusHubSuperconductorsExchange.js - Planetary Commodity Trade & Supply Chain Model: ArcturusHub -> Superconductors.
 */

class ArcturusHubSuperconductorsExchange {
  constructor(initialStockpile = 3700) {
    this.starSystem = 'ArcturusHub';
    this.commodity = 'Superconductors';
    this.stockpileUnits = initialStockpile;
    this.basePriceCredits = 305;
...
module.exports = { ArcturusHubSuperconductorsExchange };
