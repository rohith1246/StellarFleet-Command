/**
 * ArcturusHubQuantumProcessorsExchange.js - Planetary Commodity Trade & Supply Chain Model: ArcturusHub -> QuantumProcessors.
 */

class ArcturusHubQuantumProcessorsExchange {
  constructor(initialStockpile = 3500) {
    this.starSystem = 'ArcturusHub';
    this.commodity = 'QuantumProcessors';
    this.stockpileUnits = initialStockpile;
    this.basePriceCredits = 225;
...
module.exports = { ArcturusHubQuantumProcessorsExchange };
