/**
 * ArcturusHubBioNutrientsExchange.js - Planetary Commodity Trade & Supply Chain Model: ArcturusHub -> BioNutrients.
 */

class ArcturusHubBioNutrientsExchange {
  constructor(initialStockpile = 3600) {
...
module.exports = { ArcturusHubBioNutrientsExchange };
