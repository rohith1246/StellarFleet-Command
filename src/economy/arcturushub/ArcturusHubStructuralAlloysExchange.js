/**
 * ArcturusHubStructuralAlloysExchange.js - Planetary Commodity Trade & Supply Chain Model: ArcturusHub -> StructuralAlloys.
 */

class ArcturusHubStructuralAlloysExchange {
  constructor(initialStockpile = 3850) {
...
module.exports = { ArcturusHubStructuralAlloysExchange };
