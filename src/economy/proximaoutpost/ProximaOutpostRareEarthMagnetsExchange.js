/**
 * ProximaOutpostRareEarthMagnetsExchange.js - Planetary Commodity Trade & Supply Chain Model: ProximaOutpost -> RareEarthMagnets.
 */

class ProximaOutpostRareEarthMagnetsExchange {
  constructor(initialStockpile = 2350) {
    this.starSystem = 'ProximaOutpost';
    this.commodity = 'RareEarthMagnets';
    this.stockpileUnits = initialStockpile;
    this.basePriceCredits = 140;
...
module.exports = { ProximaOutpostRareEarthMagnetsExchange };
