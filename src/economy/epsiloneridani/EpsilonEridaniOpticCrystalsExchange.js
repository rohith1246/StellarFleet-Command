/**
 * EpsilonEridaniOpticCrystalsExchange.js - Planetary Commodity Trade & Supply Chain Model: EpsilonEridani -> OpticCrystals.
 */

class EpsilonEridaniOpticCrystalsExchange {
...
module.exports = { EpsilonEridaniOpticCrystalsExchange };
