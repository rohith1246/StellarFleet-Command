/**
 * EpsilonEridaniQuantumProcessorsExchange.js - Planetary Commodity Trade & Supply Chain Model: EpsilonEridani -> QuantumProcessors.
 */

class EpsilonEridaniQuantumProcessorsExchange {
  constructor(initialStockpile = 3100) {
    this.starSystem = 'EpsilonEridani';
    this.commodity = 'QuantumProcessors';
    this.stockpileUnits = initialStockpile;
    this.basePriceCredits = 215;
...
module.exports = { EpsilonEridaniQuantumProcessorsExchange };
