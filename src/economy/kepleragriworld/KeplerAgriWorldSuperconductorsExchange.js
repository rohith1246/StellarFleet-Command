/**
 * KeplerAgriWorldSuperconductorsExchange.js - Planetary Commodity Trade & Supply Chain Model: KeplerAgriWorld -> Superconductors.
 */

class KeplerAgriWorldSuperconductorsExchange {
  constructor(initialStockpile = 2500) {
    this.starSystem = 'KeplerAgriWorld';
    this.commodity = 'Superconductors';
    this.stockpileUnits = initialStockpile;
    this.basePriceCredits = 275;
...
module.exports = { KeplerAgriWorldSuperconductorsExchange };
