/**
 * KeplerAgriWorldRareEarthMagnetsExchange.js - Planetary Commodity Trade & Supply Chain Model: KeplerAgriWorld -> RareEarthMagnets.
 */

class KeplerAgriWorldRareEarthMagnetsExchange {
  constructor(initialStockpile = 2150) {
    this.starSystem = 'KeplerAgriWorld';
    this.commodity = 'RareEarthMagnets';
    this.stockpileUnits = initialStockpile;
    this.basePriceCredits = 135;
...
module.exports = { KeplerAgriWorldRareEarthMagnetsExchange };
