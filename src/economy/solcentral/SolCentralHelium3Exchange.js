/**
 * SolCentralHelium3Exchange.js - Planetary Commodity Trade & Supply Chain Model: SolCentral -> Helium3.
 */

class SolCentralHelium3Exchange {
  constructor(initialStockpile = 1000) {
    this.starSystem = 'SolCentral';
    this.commodity = 'Helium3';
    this.stockpileUnits = initialStockpile;
    this.basePriceCredits = 50;
...
module.exports = { SolCentralHelium3Exchange };
