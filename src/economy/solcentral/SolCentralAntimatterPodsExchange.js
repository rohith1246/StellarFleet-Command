/**
 * SolCentralAntimatterPodsExchange.js - Planetary Commodity Trade & Supply Chain Model: SolCentral -> AntimatterPods.
 */

class SolCentralAntimatterPodsExchange {
  constructor(initialStockpile = 1200) {
...
module.exports = { SolCentralAntimatterPodsExchange };
