/**
 * SolCentralTitaniumOreExchange.js - Planetary Commodity Trade & Supply Chain Model: SolCentral -> TitaniumOre.
 */

class SolCentralTitaniumOreExchange {
  constructor(initialStockpile = 1100) {
...
module.exports = { SolCentralTitaniumOreExchange };
