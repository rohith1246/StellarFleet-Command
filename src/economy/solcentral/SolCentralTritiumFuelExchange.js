/**
 * SolCentralTritiumFuelExchange.js - Planetary Commodity Trade & Supply Chain Model: SolCentral -> TritiumFuel.
 */

class SolCentralTritiumFuelExchange {
  constructor(initialStockpile = 1050) {
...
module.exports = { SolCentralTritiumFuelExchange };
