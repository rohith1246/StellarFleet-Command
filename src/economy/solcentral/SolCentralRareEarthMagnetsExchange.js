/**
 * SolCentralRareEarthMagnetsExchange.js - Planetary Commodity Trade & Supply Chain Model: SolCentral -> RareEarthMagnets.
 */

class SolCentralRareEarthMagnetsExchange {
  constructor(initialStockpile = 1150) {
...
module.exports = { SolCentralRareEarthMagnetsExchange };
