/**
 * RigelCitadelQuantumProcessorsExchange.js - Planetary Commodity Trade & Supply Chain Model: RigelCitadel -> QuantumProcessors.
 */

class RigelCitadelQuantumProcessorsExchange {
  constructor(initialStockpile = 3300) {
...
module.exports = { RigelCitadelQuantumProcessorsExchange };
