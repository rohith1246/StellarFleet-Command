/**
 * PolarisVaultRareEarthMagnetsExchange.js - Planetary Commodity Trade & Supply Chain Model: PolarisVault -> RareEarthMagnets.
 */

class PolarisVaultRareEarthMagnetsExchange {
  constructor(initialStockpile = 3550) {
    this.starSystem = 'PolarisVault';
    this.commodity = 'RareEarthMagnets';
    this.stockpileUnits = initialStockpile;
    this.basePriceCredits = 170;
...
module.exports = { PolarisVaultRareEarthMagnetsExchange };
