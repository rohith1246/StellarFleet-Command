/**
 * SiriusPrimeStructuralAlloysExchange.js - Planetary Commodity Trade & Supply Chain Model: SiriusPrime -> StructuralAlloys.
 */

class SiriusPrimeStructuralAlloysExchange {
  constructor(initialStockpile = 2050) {
...
module.exports = { SiriusPrimeStructuralAlloysExchange };
