/**
 * SiriusPrimeHelium3Exchange.js - Planetary Commodity Trade & Supply Chain Model: SiriusPrime -> Helium3.
 */

class SiriusPrimeHelium3Exchange {
  constructor(initialStockpile = 1400) {
    this.starSystem = 'SiriusPrime';
    this.commodity = 'Helium3';
    this.stockpileUnits = initialStockpile;
    this.basePriceCredits = 60;
...
module.exports = { SiriusPrimeHelium3Exchange };
