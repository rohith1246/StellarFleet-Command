/**
 * SiriusPrimeRareEarthMagnetsExchange.js - Planetary Commodity Trade & Supply Chain Model: SiriusPrime -> RareEarthMagnets.
 */

class SiriusPrimeRareEarthMagnetsExchange {
  constructor(initialStockpile = 1550) {
    this.starSystem = 'SiriusPrime';
...
module.exports = { SiriusPrimeRareEarthMagnetsExchange };
