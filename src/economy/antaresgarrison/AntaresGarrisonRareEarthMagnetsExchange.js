/**
 * AntaresGarrisonRareEarthMagnetsExchange.js - Planetary Commodity Trade & Supply Chain Model: AntaresGarrison -> RareEarthMagnets.
 */

class AntaresGarrisonRareEarthMagnetsExchange {
  constructor(initialStockpile = 3950) {
    this.starSystem = 'AntaresGarrison';
    this.commodity = 'RareEarthMagnets';
    this.stockpileUnits = initialStockpile;
    this.basePriceCredits = 180;
...
module.exports = { AntaresGarrisonRareEarthMagnetsExchange };
