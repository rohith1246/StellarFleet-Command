/**
 * AlphaCentauriHydrocarbonChainsExchange.js - Planetary Commodity Trade & Supply Chain Model: AlphaCentauri -> HydrocarbonChains.
 */

class AlphaCentauriHydrocarbonChainsExchange {
  constructor(initialStockpile = 1650) {
...
module.exports = { AlphaCentauriHydrocarbonChainsExchange };
