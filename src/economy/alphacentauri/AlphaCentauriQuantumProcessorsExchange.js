/**
 * AlphaCentauriQuantumProcessorsExchange.js - Planetary Commodity Trade & Supply Chain Model: AlphaCentauri -> QuantumProcessors.
 */

class AlphaCentauriQuantumProcessorsExchange {
  constructor(initialStockpile = 1500) {
...
module.exports = { AlphaCentauriQuantumProcessorsExchange };
