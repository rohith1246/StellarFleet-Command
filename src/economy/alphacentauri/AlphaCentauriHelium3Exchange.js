/**
 * AlphaCentauriHelium3Exchange.js - Planetary Commodity Trade & Supply Chain Model: AlphaCentauri -> Helium3.
 */

class AlphaCentauriHelium3Exchange {
  constructor(initialStockpile = 1200) {
    this.starSystem = 'AlphaCentauri';
    this.commodity = 'Helium3';
    this.stockpileUnits = initialStockpile;
    this.basePriceCredits = 55;
...
module.exports = { AlphaCentauriHelium3Exchange };
