/**
 * AlphaCentauriAntimatterPodsExchange.js - Planetary Commodity Trade & Supply Chain Model: AlphaCentauri -> AntimatterPods.
 */

class AlphaCentauriAntimatterPodsExchange {
  constructor(initialStockpile = 1400) {
...
module.exports = { AlphaCentauriAntimatterPodsExchange };
