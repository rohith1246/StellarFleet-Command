/**
 * CanopusFoundryQuantumProcessorsExchange.js - Planetary Commodity Trade & Supply Chain Model: CanopusFoundry -> QuantumProcessors.
 */

class CanopusFoundryQuantumProcessorsExchange {
  constructor(initialStockpile = 3900) {
    this.starSystem = 'CanopusFoundry';
    this.commodity = 'QuantumProcessors';
    this.stockpileUnits = initialStockpile;
    this.basePriceCredits = 235;
...
module.exports = { CanopusFoundryQuantumProcessorsExchange };
