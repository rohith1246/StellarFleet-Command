/**
 * CanopusFoundryHyperdriveCoresExchange.js - Planetary Commodity Trade & Supply Chain Model: CanopusFoundry -> HyperdriveCores.
 */

class CanopusFoundryHyperdriveCoresExchange {
  constructor(initialStockpile = 4200) {
    this.starSystem = 'CanopusFoundry';
    this.commodity = 'HyperdriveCores';
    this.stockpileUnits = initialStockpile;
    this.basePriceCredits = 355;
...
module.exports = { CanopusFoundryHyperdriveCoresExchange };
