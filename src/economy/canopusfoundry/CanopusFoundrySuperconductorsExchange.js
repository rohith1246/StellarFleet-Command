/**
 * CanopusFoundrySuperconductorsExchange.js - Planetary Commodity Trade & Supply Chain Model: CanopusFoundry -> Superconductors.
 */

class CanopusFoundrySuperconductorsExchange {
  constructor(initialStockpile = 4100) {
...
module.exports = { CanopusFoundrySuperconductorsExchange };
