/**
 * CanopusFoundryRareEarthMagnetsExchange.js - Planetary Commodity Trade & Supply Chain Model: CanopusFoundry -> RareEarthMagnets.
 */

class CanopusFoundryRareEarthMagnetsExchange {
  constructor(initialStockpile = 3750) {
    this.starSystem = 'CanopusFoundry';
    this.commodity = 'RareEarthMagnets';
    this.stockpileUnits = initialStockpile;
    this.basePriceCredits = 175;
...
module.exports = { CanopusFoundryRareEarthMagnetsExchange };
