/**
 * CanopusFoundryStructuralAlloysExchange.js - Planetary Commodity Trade & Supply Chain Model: CanopusFoundry -> StructuralAlloys.
 */

class CanopusFoundryStructuralAlloysExchange {
  constructor(initialStockpile = 4250) {
    this.starSystem = 'CanopusFoundry';
    this.commodity = 'StructuralAlloys';
    this.stockpileUnits = initialStockpile;
    this.basePriceCredits = 375;
...
module.exports = { CanopusFoundryStructuralAlloysExchange };
