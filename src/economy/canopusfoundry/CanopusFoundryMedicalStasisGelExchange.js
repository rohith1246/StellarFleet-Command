/**
 * CanopusFoundryMedicalStasisGelExchange.js - Planetary Commodity Trade & Supply Chain Model: CanopusFoundry -> MedicalStasisGel.
 */

class CanopusFoundryMedicalStasisGelExchange {
  constructor(initialStockpile = 4350) {
    this.starSystem = 'CanopusFoundry';
    this.commodity = 'MedicalStasisGel';
    this.stockpileUnits = initialStockpile;
    this.basePriceCredits = 415;
...
module.exports = { CanopusFoundryMedicalStasisGelExchange };
