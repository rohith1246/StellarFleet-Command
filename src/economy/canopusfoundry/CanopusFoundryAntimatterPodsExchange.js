/**
 * CanopusFoundryAntimatterPodsExchange.js - Planetary Commodity Trade & Supply Chain Model: CanopusFoundry -> AntimatterPods.
 */

class CanopusFoundryAntimatterPodsExchange {
  constructor(initialStockpile = 3800) {
    this.starSystem = 'CanopusFoundry';
    this.commodity = 'AntimatterPods';
    this.stockpileUnits = initialStockpile;
    this.basePriceCredits = 195;
...
module.exports = { CanopusFoundryAntimatterPodsExchange };
