/**
 * DenebResearchStructuralAlloysExchange.js - Planetary Commodity Trade & Supply Chain Model: DenebResearch -> StructuralAlloys.
 */

class DenebResearchStructuralAlloysExchange {
  constructor(initialStockpile = 4650) {
...
module.exports = { DenebResearchStructuralAlloysExchange };
