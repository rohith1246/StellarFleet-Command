/**
 * DenebResearchSuperconductorsExchange.js - Planetary Commodity Trade & Supply Chain Model: DenebResearch -> Superconductors.
 */

class DenebResearchSuperconductorsExchange {
  constructor(initialStockpile = 4500) {
    this.starSystem = 'DenebResearch';
    this.commodity = 'Superconductors';
    this.stockpileUnits = initialStockpile;
    this.basePriceCredits = 325;
...
module.exports = { DenebResearchSuperconductorsExchange };
