/**
 * DenebResearchQuantumProcessorsExchange.js - Planetary Commodity Trade & Supply Chain Model: DenebResearch -> QuantumProcessors.
 */

class DenebResearchQuantumProcessorsExchange {
  constructor(initialStockpile = 4300) {
    this.starSystem = 'DenebResearch';
    this.commodity = 'QuantumProcessors';
    this.stockpileUnits = initialStockpile;
    this.basePriceCredits = 245;
...
module.exports = { DenebResearchQuantumProcessorsExchange };
