/**
 * DenebResearchMedicalStasisGelExchange.js - Planetary Commodity Trade & Supply Chain Model: DenebResearch -> MedicalStasisGel.
 */

class DenebResearchMedicalStasisGelExchange {
  constructor(initialStockpile = 4750) {
    this.starSystem = 'DenebResearch';
    this.commodity = 'MedicalStasisGel';
    this.stockpileUnits = initialStockpile;
    this.basePriceCredits = 425;
...
module.exports = { DenebResearchMedicalStasisGelExchange };
