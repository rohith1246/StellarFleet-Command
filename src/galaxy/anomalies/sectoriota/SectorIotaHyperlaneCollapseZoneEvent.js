/**
 * SectorIotaHyperlaneCollapseZoneEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorIota -> HyperlaneCollapseZone.
 */

class SectorIotaHyperlaneCollapseZoneEvent {
  constructor(anomalyId = 'ano_sectoriota_9') {
...
module.exports = { SectorIotaHyperlaneCollapseZoneEvent };
