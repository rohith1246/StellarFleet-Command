/**
 * SectorIotaPrecursorSarcophagusEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorIota -> PrecursorSarcophagus.
 */

class SectorIotaPrecursorSarcophagusEvent {
  constructor(anomalyId = 'ano_sectoriota_13') {
...
module.exports = { SectorIotaPrecursorSarcophagusEvent };
