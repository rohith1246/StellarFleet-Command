/**
 * SectorIotaDarkMatterCloudEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorIota -> DarkMatterCloud.
 */

class SectorIotaDarkMatterCloudEvent {
  constructor(anomalyId = 'ano_sectoriota_4') {
...
module.exports = { SectorIotaDarkMatterCloudEvent };
