/**
 * SectorIotaSubspaceBeaconSignalEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorIota -> SubspaceBeaconSignal.
 */

class SectorIotaSubspaceBeaconSignalEvent {
  constructor(anomalyId = 'ano_sectoriota_6') {
...
module.exports = { SectorIotaSubspaceBeaconSignalEvent };
