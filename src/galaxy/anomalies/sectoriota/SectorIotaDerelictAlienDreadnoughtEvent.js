/**
 * SectorIotaDerelictAlienDreadnoughtEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorIota -> DerelictAlienDreadnought.
 */

class SectorIotaDerelictAlienDreadnoughtEvent {
  constructor(anomalyId = 'ano_sectoriota_0') {
...
module.exports = { SectorIotaDerelictAlienDreadnoughtEvent };
