/**
 * SectorIotaPlasmaStormCorridorEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorIota -> PlasmaStormCorridor.
 */

class SectorIotaPlasmaStormCorridorEvent {
  constructor(anomalyId = 'ano_sectoriota_12') {
...
module.exports = { SectorIotaPlasmaStormCorridorEvent };
