/**
 * SectorNuSubspaceBeaconSignalEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorNu -> SubspaceBeaconSignal.
 */

class SectorNuSubspaceBeaconSignalEvent {
  constructor(anomalyId = 'ano_sectornu_6') {
...
module.exports = { SectorNuSubspaceBeaconSignalEvent };
