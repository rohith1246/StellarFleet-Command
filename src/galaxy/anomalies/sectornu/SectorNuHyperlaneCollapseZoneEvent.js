/**
 * SectorNuHyperlaneCollapseZoneEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorNu -> HyperlaneCollapseZone.
 */

class SectorNuHyperlaneCollapseZoneEvent {
  constructor(anomalyId = 'ano_sectornu_9') {
...
module.exports = { SectorNuHyperlaneCollapseZoneEvent };
