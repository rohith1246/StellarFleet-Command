/**
 * SectorNuPlasmaStormCorridorEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorNu -> PlasmaStormCorridor.
 */

class SectorNuPlasmaStormCorridorEvent {
  constructor(anomalyId = 'ano_sectornu_12') {
...
module.exports = { SectorNuPlasmaStormCorridorEvent };
