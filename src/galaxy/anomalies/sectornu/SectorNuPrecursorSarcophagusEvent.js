/**
 * SectorNuPrecursorSarcophagusEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorNu -> PrecursorSarcophagus.
 */

class SectorNuPrecursorSarcophagusEvent {
  constructor(anomalyId = 'ano_sectornu_13') {
...
module.exports = { SectorNuPrecursorSarcophagusEvent };
