/**
 * SectorNuWormholeUnstableRiftEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorNu -> WormholeUnstableRift.
 */

class SectorNuWormholeUnstableRiftEvent {
  constructor(anomalyId = 'ano_sectornu_1') {
...
module.exports = { SectorNuWormholeUnstableRiftEvent };
