/**
 * SectorLambdaDerelictAlienDreadnoughtEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorLambda -> DerelictAlienDreadnought.
 */

class SectorLambdaDerelictAlienDreadnoughtEvent {
  constructor(anomalyId = 'ano_sectorlambda_0') {
    this.anomalyId = anomalyId;
    this.sector = 'SectorLambda';
    this.anomalyType = 'DerelictAlienDreadnought';
    this.scanningDifficulty = 3;
    this.sciencePointsReward = 1500;
...
module.exports = { SectorLambdaDerelictAlienDreadnoughtEvent };
