/**
 * SectorLambdaPrecursorSarcophagusEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorLambda -> PrecursorSarcophagus.
 */

class SectorLambdaPrecursorSarcophagusEvent {
  constructor(anomalyId = 'ano_sectorlambda_13') {
...
module.exports = { SectorLambdaPrecursorSarcophagusEvent };
