/**
 * SectorLambdaWormholeUnstableRiftEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorLambda -> WormholeUnstableRift.
 */

class SectorLambdaWormholeUnstableRiftEvent {
  constructor(anomalyId = 'ano_sectorlambda_1') {
...
module.exports = { SectorLambdaWormholeUnstableRiftEvent };
