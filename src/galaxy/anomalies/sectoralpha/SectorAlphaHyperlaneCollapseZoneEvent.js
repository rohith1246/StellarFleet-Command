/**
 * SectorAlphaHyperlaneCollapseZoneEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorAlpha -> HyperlaneCollapseZone.
 */

class SectorAlphaHyperlaneCollapseZoneEvent {
  constructor(anomalyId = 'ano_sectoralpha_9') {
...
module.exports = { SectorAlphaHyperlaneCollapseZoneEvent };
