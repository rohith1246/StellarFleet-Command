/**
 * SectorAlphaPrecursorSarcophagusEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorAlpha -> PrecursorSarcophagus.
 */

class SectorAlphaPrecursorSarcophagusEvent {
  constructor(anomalyId = 'ano_sectoralpha_13') {
...
module.exports = { SectorAlphaPrecursorSarcophagusEvent };
