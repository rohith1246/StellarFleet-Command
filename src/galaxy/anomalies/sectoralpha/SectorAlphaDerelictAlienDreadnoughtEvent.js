/**
 * SectorAlphaDerelictAlienDreadnoughtEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorAlpha -> DerelictAlienDreadnought.
 */

class SectorAlphaDerelictAlienDreadnoughtEvent {
  constructor(anomalyId = 'ano_sectoralpha_0') {
    this.anomalyId = anomalyId;
    this.sector = 'SectorAlpha';
    this.anomalyType = 'DerelictAlienDreadnought';
    this.scanningDifficulty = 3;
    this.sciencePointsReward = 500;
...
module.exports = { SectorAlphaDerelictAlienDreadnoughtEvent };
