/**
 * SectorAlphaAncientMegastructureRuinsEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorAlpha -> AncientMegastructureRuins.
 */

class SectorAlphaAncientMegastructureRuinsEvent {
  constructor(anomalyId = 'ano_sectoralpha_3') {
    this.anomalyId = anomalyId;
    this.sector = 'SectorAlpha';
    this.anomalyType = 'AncientMegastructureRuins';
    this.scanningDifficulty = 6;
    this.sciencePointsReward = 650;
...
module.exports = { SectorAlphaAncientMegastructureRuinsEvent };
