/**
 * SectorAlphaWormholeUnstableRiftEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorAlpha -> WormholeUnstableRift.
 */

class SectorAlphaWormholeUnstableRiftEvent {
  constructor(anomalyId = 'ano_sectoralpha_1') {
    this.anomalyId = anomalyId;
    this.sector = 'SectorAlpha';
    this.anomalyType = 'WormholeUnstableRift';
    this.scanningDifficulty = 4;
    this.sciencePointsReward = 550;
...
module.exports = { SectorAlphaWormholeUnstableRiftEvent };
