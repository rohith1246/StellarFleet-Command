/**
 * SectorAlphaDarkMatterCloudEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorAlpha -> DarkMatterCloud.
 */

class SectorAlphaDarkMatterCloudEvent {
  constructor(anomalyId = 'ano_sectoralpha_4') {
...
module.exports = { SectorAlphaDarkMatterCloudEvent };
