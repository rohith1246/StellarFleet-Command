/**
 * SectorDeltaWormholeUnstableRiftEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorDelta -> WormholeUnstableRift.
 */

class SectorDeltaWormholeUnstableRiftEvent {
  constructor(anomalyId = 'ano_sectordelta_1') {
...
module.exports = { SectorDeltaWormholeUnstableRiftEvent };
