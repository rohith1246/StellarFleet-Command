/**
 * SectorDeltaTemporalDistortionFieldEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorDelta -> TemporalDistortionField.
 */

class SectorDeltaTemporalDistortionFieldEvent {
  constructor(anomalyId = 'ano_sectordelta_8') {
...
module.exports = { SectorDeltaTemporalDistortionFieldEvent };
