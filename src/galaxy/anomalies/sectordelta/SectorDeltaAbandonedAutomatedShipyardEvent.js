/**
 * SectorDeltaAbandonedAutomatedShipyardEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorDelta -> AbandonedAutomatedShipyard.
 */

class SectorDeltaAbandonedAutomatedShipyardEvent {
  constructor(anomalyId = 'ano_sectordelta_10') {
...
module.exports = { SectorDeltaAbandonedAutomatedShipyardEvent };
