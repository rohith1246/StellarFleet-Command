/**
 * SectorDeltaPlasmaStormCorridorEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorDelta -> PlasmaStormCorridor.
 */

class SectorDeltaPlasmaStormCorridorEvent {
  constructor(anomalyId = 'ano_sectordelta_12') {
...
module.exports = { SectorDeltaPlasmaStormCorridorEvent };
