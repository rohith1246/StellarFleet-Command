/**
 * SectorDeltaDarkMatterCloudEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorDelta -> DarkMatterCloud.
 */

class SectorDeltaDarkMatterCloudEvent {
  constructor(anomalyId = 'ano_sectordelta_4') {
...
module.exports = { SectorDeltaDarkMatterCloudEvent };
