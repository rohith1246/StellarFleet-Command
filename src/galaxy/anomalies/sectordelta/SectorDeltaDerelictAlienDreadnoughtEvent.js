/**
 * SectorDeltaDerelictAlienDreadnoughtEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorDelta -> DerelictAlienDreadnought.
 */

class SectorDeltaDerelictAlienDreadnoughtEvent {
  constructor(anomalyId = 'ano_sectordelta_0') {
...
module.exports = { SectorDeltaDerelictAlienDreadnoughtEvent };
