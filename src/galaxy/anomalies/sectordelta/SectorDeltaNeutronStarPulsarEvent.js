/**
 * SectorDeltaNeutronStarPulsarEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorDelta -> NeutronStarPulsar.
 */

class SectorDeltaNeutronStarPulsarEvent {
  constructor(anomalyId = 'ano_sectordelta_2') {
...
module.exports = { SectorDeltaNeutronStarPulsarEvent };
