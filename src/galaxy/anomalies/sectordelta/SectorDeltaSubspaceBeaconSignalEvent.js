/**
 * SectorDeltaSubspaceBeaconSignalEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorDelta -> SubspaceBeaconSignal.
 */

class SectorDeltaSubspaceBeaconSignalEvent {
  constructor(anomalyId = 'ano_sectordelta_6') {
...
module.exports = { SectorDeltaSubspaceBeaconSignalEvent };
