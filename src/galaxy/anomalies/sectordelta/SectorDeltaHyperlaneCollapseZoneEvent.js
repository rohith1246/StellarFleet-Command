/**
 * SectorDeltaHyperlaneCollapseZoneEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorDelta -> HyperlaneCollapseZone.
 */

class SectorDeltaHyperlaneCollapseZoneEvent {
  constructor(anomalyId = 'ano_sectordelta_9') {
...
module.exports = { SectorDeltaHyperlaneCollapseZoneEvent };
