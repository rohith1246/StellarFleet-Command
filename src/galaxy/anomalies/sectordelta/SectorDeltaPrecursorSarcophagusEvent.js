/**
 * SectorDeltaPrecursorSarcophagusEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorDelta -> PrecursorSarcophagus.
 */

class SectorDeltaPrecursorSarcophagusEvent {
  constructor(anomalyId = 'ano_sectordelta_13') {
...
module.exports = { SectorDeltaPrecursorSarcophagusEvent };
