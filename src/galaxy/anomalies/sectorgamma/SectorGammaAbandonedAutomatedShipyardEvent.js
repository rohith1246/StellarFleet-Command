/**
 * SectorGammaAbandonedAutomatedShipyardEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorGamma -> AbandonedAutomatedShipyard.
 */

class SectorGammaAbandonedAutomatedShipyardEvent {
  constructor(anomalyId = 'ano_sectorgamma_10') {
    this.anomalyId = anomalyId;
    this.sector = 'SectorGamma';
    this.anomalyType = 'AbandonedAutomatedShipyard';
    this.scanningDifficulty = 9;
    this.sciencePointsReward = 1200;
...
module.exports = { SectorGammaAbandonedAutomatedShipyardEvent };
