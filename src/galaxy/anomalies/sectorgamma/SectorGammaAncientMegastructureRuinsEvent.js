/**
 * SectorGammaAncientMegastructureRuinsEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorGamma -> AncientMegastructureRuins.
 */

class SectorGammaAncientMegastructureRuinsEvent {
  constructor(anomalyId = 'ano_sectorgamma_3') {
    this.anomalyId = anomalyId;
    this.sector = 'SectorGamma';
    this.anomalyType = 'AncientMegastructureRuins';
    this.scanningDifficulty = 10;
    this.sciencePointsReward = 850;
...
module.exports = { SectorGammaAncientMegastructureRuinsEvent };
