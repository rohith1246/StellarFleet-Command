/**
 * SectorGammaHyperlaneCollapseZoneEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorGamma -> HyperlaneCollapseZone.
 */

class SectorGammaHyperlaneCollapseZoneEvent {
  constructor(anomalyId = 'ano_sectorgamma_9') {
...
module.exports = { SectorGammaHyperlaneCollapseZoneEvent };
