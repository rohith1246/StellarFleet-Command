/**
 * SectorGammaPrecursorSarcophagusEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorGamma -> PrecursorSarcophagus.
 */

class SectorGammaPrecursorSarcophagusEvent {
  constructor(anomalyId = 'ano_sectorgamma_13') {
...
module.exports = { SectorGammaPrecursorSarcophagusEvent };
