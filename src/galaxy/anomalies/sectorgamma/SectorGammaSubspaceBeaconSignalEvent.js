/**
 * SectorGammaSubspaceBeaconSignalEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorGamma -> SubspaceBeaconSignal.
 */

class SectorGammaSubspaceBeaconSignalEvent {
  constructor(anomalyId = 'ano_sectorgamma_6') {
...
module.exports = { SectorGammaSubspaceBeaconSignalEvent };
