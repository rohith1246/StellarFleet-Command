/**
 * SectorOmicronNeutronStarPulsarEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorOmicron -> NeutronStarPulsar.
 */

class SectorOmicronNeutronStarPulsarEvent {
  constructor(anomalyId = 'ano_sectoromicron_2') {
...
module.exports = { SectorOmicronNeutronStarPulsarEvent };
