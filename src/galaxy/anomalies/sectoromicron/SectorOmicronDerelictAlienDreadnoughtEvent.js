/**
 * SectorOmicronDerelictAlienDreadnoughtEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorOmicron -> DerelictAlienDreadnought.
 */

class SectorOmicronDerelictAlienDreadnoughtEvent {
  constructor(anomalyId = 'ano_sectoromicron_0') {
...
module.exports = { SectorOmicronDerelictAlienDreadnoughtEvent };
