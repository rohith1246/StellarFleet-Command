/**
 * SectorOmicronSingularityFountainEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorOmicron -> SingularityFountain.
 */

class SectorOmicronSingularityFountainEvent {
  constructor(anomalyId = 'ano_sectoromicron_14') {
    this.anomalyId = anomalyId;
    this.sector = 'SectorOmicron';
    this.anomalyType = 'SingularityFountain';
    this.scanningDifficulty = 13;
    this.sciencePointsReward = 2600;
...
module.exports = { SectorOmicronSingularityFountainEvent };
