/**
 * SectorOmicronSubspaceBeaconSignalEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorOmicron -> SubspaceBeaconSignal.
 */

class SectorOmicronSubspaceBeaconSignalEvent {
  constructor(anomalyId = 'ano_sectoromicron_6') {
...
module.exports = { SectorOmicronSubspaceBeaconSignalEvent };
