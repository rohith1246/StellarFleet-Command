/**
 * SectorOmicronHyperlaneCollapseZoneEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorOmicron -> HyperlaneCollapseZone.
 */

class SectorOmicronHyperlaneCollapseZoneEvent {
  constructor(anomalyId = 'ano_sectoromicron_9') {
    this.anomalyId = anomalyId;
    this.sector = 'SectorOmicron';
    this.anomalyType = 'HyperlaneCollapseZone';
    this.scanningDifficulty = 12;
    this.sciencePointsReward = 2350;
...
module.exports = { SectorOmicronHyperlaneCollapseZoneEvent };
