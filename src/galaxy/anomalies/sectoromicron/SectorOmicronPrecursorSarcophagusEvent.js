/**
 * SectorOmicronPrecursorSarcophagusEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorOmicron -> PrecursorSarcophagus.
 */

class SectorOmicronPrecursorSarcophagusEvent {
  constructor(anomalyId = 'ano_sectoromicron_13') {
    this.anomalyId = anomalyId;
    this.sector = 'SectorOmicron';
    this.anomalyType = 'PrecursorSarcophagus';
    this.scanningDifficulty = 12;
    this.sciencePointsReward = 2550;
...
module.exports = { SectorOmicronPrecursorSarcophagusEvent };
