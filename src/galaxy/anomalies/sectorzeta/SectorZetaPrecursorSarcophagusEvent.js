/**
 * SectorZetaPrecursorSarcophagusEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorZeta -> PrecursorSarcophagus.
 */

class SectorZetaPrecursorSarcophagusEvent {
  constructor(anomalyId = 'ano_sectorzeta_13') {
...
module.exports = { SectorZetaPrecursorSarcophagusEvent };
