/**
 * SectorZetaNeutronStarPulsarEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorZeta -> NeutronStarPulsar.
 */

class SectorZetaNeutronStarPulsarEvent {
  constructor(anomalyId = 'ano_sectorzeta_2') {
...
module.exports = { SectorZetaNeutronStarPulsarEvent };
