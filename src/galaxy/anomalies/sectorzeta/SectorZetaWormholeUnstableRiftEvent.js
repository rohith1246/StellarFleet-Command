/**
 * SectorZetaWormholeUnstableRiftEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorZeta -> WormholeUnstableRift.
 */

class SectorZetaWormholeUnstableRiftEvent {
  constructor(anomalyId = 'ano_sectorzeta_1') {
...
module.exports = { SectorZetaWormholeUnstableRiftEvent };
