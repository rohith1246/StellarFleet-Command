/**
 * SectorZetaHyperlaneCollapseZoneEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorZeta -> HyperlaneCollapseZone.
 */

class SectorZetaHyperlaneCollapseZoneEvent {
  constructor(anomalyId = 'ano_sectorzeta_9') {
...
module.exports = { SectorZetaHyperlaneCollapseZoneEvent };
