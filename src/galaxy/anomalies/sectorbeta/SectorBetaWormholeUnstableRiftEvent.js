/**
 * SectorBetaWormholeUnstableRiftEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorBeta -> WormholeUnstableRift.
 */

class SectorBetaWormholeUnstableRiftEvent {
  constructor(anomalyId = 'ano_sectorbeta_1') {
...
module.exports = { SectorBetaWormholeUnstableRiftEvent };
