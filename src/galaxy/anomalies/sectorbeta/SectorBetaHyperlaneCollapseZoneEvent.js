/**
 * SectorBetaHyperlaneCollapseZoneEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorBeta -> HyperlaneCollapseZone.
 */

class SectorBetaHyperlaneCollapseZoneEvent {
  constructor(anomalyId = 'ano_sectorbeta_9') {
...
module.exports = { SectorBetaHyperlaneCollapseZoneEvent };
