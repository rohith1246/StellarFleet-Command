/**
 * SectorBetaPrecursorSarcophagusEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorBeta -> PrecursorSarcophagus.
 */

class SectorBetaPrecursorSarcophagusEvent {
  constructor(anomalyId = 'ano_sectorbeta_13') {
...
module.exports = { SectorBetaPrecursorSarcophagusEvent };
