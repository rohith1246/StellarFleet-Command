/**
 * SectorBetaPlasmaStormCorridorEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorBeta -> PlasmaStormCorridor.
 */

class SectorBetaPlasmaStormCorridorEvent {
  constructor(anomalyId = 'ano_sectorbeta_12') {
...
module.exports = { SectorBetaPlasmaStormCorridorEvent };
