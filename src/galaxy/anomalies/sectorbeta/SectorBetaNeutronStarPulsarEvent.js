/**
 * SectorBetaNeutronStarPulsarEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorBeta -> NeutronStarPulsar.
 */

class SectorBetaNeutronStarPulsarEvent {
  constructor(anomalyId = 'ano_sectorbeta_2') {
...
module.exports = { SectorBetaNeutronStarPulsarEvent };
