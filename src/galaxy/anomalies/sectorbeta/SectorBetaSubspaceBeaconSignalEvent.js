/**
 * SectorBetaSubspaceBeaconSignalEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorBeta -> SubspaceBeaconSignal.
 */

class SectorBetaSubspaceBeaconSignalEvent {
  constructor(anomalyId = 'ano_sectorbeta_6') {
...
module.exports = { SectorBetaSubspaceBeaconSignalEvent };
