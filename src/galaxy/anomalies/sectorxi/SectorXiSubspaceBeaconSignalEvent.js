/**
 * SectorXiSubspaceBeaconSignalEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorXi -> SubspaceBeaconSignal.
 */

class SectorXiSubspaceBeaconSignalEvent {
  constructor(anomalyId = 'ano_sectorxi_6') {
...
module.exports = { SectorXiSubspaceBeaconSignalEvent };
