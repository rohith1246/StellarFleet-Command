/**
 * SectorXiAbandonedAutomatedShipyardEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorXi -> AbandonedAutomatedShipyard.
 */

class SectorXiAbandonedAutomatedShipyardEvent {
  constructor(anomalyId = 'ano_sectorxi_10') {
...
module.exports = { SectorXiAbandonedAutomatedShipyardEvent };
