/**
 * SectorXiNeutronStarPulsarEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorXi -> NeutronStarPulsar.
 */

class SectorXiNeutronStarPulsarEvent {
  constructor(anomalyId = 'ano_sectorxi_2') {
...
module.exports = { SectorXiNeutronStarPulsarEvent };
