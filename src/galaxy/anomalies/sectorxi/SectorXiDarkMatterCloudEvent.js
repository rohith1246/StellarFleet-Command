/**
 * SectorXiDarkMatterCloudEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorXi -> DarkMatterCloud.
 */

class SectorXiDarkMatterCloudEvent {
  constructor(anomalyId = 'ano_sectorxi_4') {
...
module.exports = { SectorXiDarkMatterCloudEvent };
