/**
 * SectorXiDerelictAlienDreadnoughtEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorXi -> DerelictAlienDreadnought.
 */

class SectorXiDerelictAlienDreadnoughtEvent {
  constructor(anomalyId = 'ano_sectorxi_0') {
...
module.exports = { SectorXiDerelictAlienDreadnoughtEvent };
