/**
 * SectorXiLivingSpaceLeviathanEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorXi -> LivingSpaceLeviathan.
 */

class SectorXiLivingSpaceLeviathanEvent {
  constructor(anomalyId = 'ano_sectorxi_7') {
...
module.exports = { SectorXiLivingSpaceLeviathanEvent };
