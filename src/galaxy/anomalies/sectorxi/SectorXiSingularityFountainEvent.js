/**
 * SectorXiSingularityFountainEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorXi -> SingularityFountain.
 */

class SectorXiSingularityFountainEvent {
  constructor(anomalyId = 'ano_sectorxi_14') {
...
module.exports = { SectorXiSingularityFountainEvent };
