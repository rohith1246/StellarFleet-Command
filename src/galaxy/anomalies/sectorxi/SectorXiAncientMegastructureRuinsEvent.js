/**
 * SectorXiAncientMegastructureRuinsEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorXi -> AncientMegastructureRuins.
 */

class SectorXiAncientMegastructureRuinsEvent {
  constructor(anomalyId = 'ano_sectorxi_3') {
...
module.exports = { SectorXiAncientMegastructureRuinsEvent };
