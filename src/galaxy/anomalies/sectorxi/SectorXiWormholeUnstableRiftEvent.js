/**
 * SectorXiWormholeUnstableRiftEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorXi -> WormholeUnstableRift.
 */

class SectorXiWormholeUnstableRiftEvent {
  constructor(anomalyId = 'ano_sectorxi_1') {
...
module.exports = { SectorXiWormholeUnstableRiftEvent };
