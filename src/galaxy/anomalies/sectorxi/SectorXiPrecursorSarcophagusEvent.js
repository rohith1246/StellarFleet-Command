/**
 * SectorXiPrecursorSarcophagusEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorXi -> PrecursorSarcophagus.
 */

class SectorXiPrecursorSarcophagusEvent {
  constructor(anomalyId = 'ano_sectorxi_13') {
...
module.exports = { SectorXiPrecursorSarcophagusEvent };
