/**
 * SectorXiPlasmaStormCorridorEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorXi -> PlasmaStormCorridor.
 */

class SectorXiPlasmaStormCorridorEvent {
  constructor(anomalyId = 'ano_sectorxi_12') {
...
module.exports = { SectorXiPlasmaStormCorridorEvent };
