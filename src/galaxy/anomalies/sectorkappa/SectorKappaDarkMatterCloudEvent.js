/**
 * SectorKappaDarkMatterCloudEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorKappa -> DarkMatterCloud.
 */

class SectorKappaDarkMatterCloudEvent {
  constructor(anomalyId = 'ano_sectorkappa_4') {
...
module.exports = { SectorKappaDarkMatterCloudEvent };
