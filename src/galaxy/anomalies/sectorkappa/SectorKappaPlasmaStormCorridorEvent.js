/**
 * SectorKappaPlasmaStormCorridorEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorKappa -> PlasmaStormCorridor.
 */

class SectorKappaPlasmaStormCorridorEvent {
  constructor(anomalyId = 'ano_sectorkappa_12') {
...
module.exports = { SectorKappaPlasmaStormCorridorEvent };
