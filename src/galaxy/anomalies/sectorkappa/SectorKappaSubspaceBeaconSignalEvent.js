/**
 * SectorKappaSubspaceBeaconSignalEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorKappa -> SubspaceBeaconSignal.
 */

class SectorKappaSubspaceBeaconSignalEvent {
  constructor(anomalyId = 'ano_sectorkappa_6') {
...
module.exports = { SectorKappaSubspaceBeaconSignalEvent };
