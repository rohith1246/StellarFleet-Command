/**
 * SectorKappaPrecursorSarcophagusEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorKappa -> PrecursorSarcophagus.
 */

class SectorKappaPrecursorSarcophagusEvent {
  constructor(anomalyId = 'ano_sectorkappa_13') {
...
module.exports = { SectorKappaPrecursorSarcophagusEvent };
