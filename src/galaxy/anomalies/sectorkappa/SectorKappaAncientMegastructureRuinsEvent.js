/**
 * SectorKappaAncientMegastructureRuinsEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorKappa -> AncientMegastructureRuins.
 */

class SectorKappaAncientMegastructureRuinsEvent {
  constructor(anomalyId = 'ano_sectorkappa_3') {
    this.anomalyId = anomalyId;
    this.sector = 'SectorKappa';
    this.anomalyType = 'AncientMegastructureRuins';
    this.scanningDifficulty = 14;
    this.sciencePointsReward = 1550;
...
module.exports = { SectorKappaAncientMegastructureRuinsEvent };
