/**
 * SectorKappaNeutronStarPulsarEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorKappa -> NeutronStarPulsar.
 */

class SectorKappaNeutronStarPulsarEvent {
  constructor(anomalyId = 'ano_sectorkappa_2') {
...
module.exports = { SectorKappaNeutronStarPulsarEvent };
