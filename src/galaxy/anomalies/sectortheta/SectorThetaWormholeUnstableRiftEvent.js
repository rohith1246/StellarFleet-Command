/**
 * SectorThetaWormholeUnstableRiftEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorTheta -> WormholeUnstableRift.
 */

class SectorThetaWormholeUnstableRiftEvent {
  constructor(anomalyId = 'ano_sectortheta_1') {
...
module.exports = { SectorThetaWormholeUnstableRiftEvent };
