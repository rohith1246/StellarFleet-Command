/**
 * SectorThetaPlasmaStormCorridorEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorTheta -> PlasmaStormCorridor.
 */

class SectorThetaPlasmaStormCorridorEvent {
  constructor(anomalyId = 'ano_sectortheta_12') {
...
module.exports = { SectorThetaPlasmaStormCorridorEvent };
