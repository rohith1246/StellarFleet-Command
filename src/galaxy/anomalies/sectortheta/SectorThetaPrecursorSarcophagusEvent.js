/**
 * SectorThetaPrecursorSarcophagusEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorTheta -> PrecursorSarcophagus.
 */

class SectorThetaPrecursorSarcophagusEvent {
  constructor(anomalyId = 'ano_sectortheta_13') {
...
module.exports = { SectorThetaPrecursorSarcophagusEvent };
