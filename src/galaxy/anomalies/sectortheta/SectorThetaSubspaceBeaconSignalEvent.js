/**
 * SectorThetaSubspaceBeaconSignalEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorTheta -> SubspaceBeaconSignal.
 */

class SectorThetaSubspaceBeaconSignalEvent {
  constructor(anomalyId = 'ano_sectortheta_6') {
...
module.exports = { SectorThetaSubspaceBeaconSignalEvent };
