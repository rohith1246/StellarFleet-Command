/**
 * SectorThetaDerelictAlienDreadnoughtEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorTheta -> DerelictAlienDreadnought.
 */

class SectorThetaDerelictAlienDreadnoughtEvent {
  constructor(anomalyId = 'ano_sectortheta_0') {
...
module.exports = { SectorThetaDerelictAlienDreadnoughtEvent };
