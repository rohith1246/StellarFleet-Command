/**
 * SectorThetaAbandonedAutomatedShipyardEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorTheta -> AbandonedAutomatedShipyard.
 */

class SectorThetaAbandonedAutomatedShipyardEvent {
  constructor(anomalyId = 'ano_sectortheta_10') {
...
module.exports = { SectorThetaAbandonedAutomatedShipyardEvent };
