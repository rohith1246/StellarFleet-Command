/**
 * SectorEtaDerelictAlienDreadnoughtEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorEta -> DerelictAlienDreadnought.
 */

class SectorEtaDerelictAlienDreadnoughtEvent {
  constructor(anomalyId = 'ano_sectoreta_0') {
...
module.exports = { SectorEtaDerelictAlienDreadnoughtEvent };
