/**
 * SectorEtaSingularityFountainEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorEta -> SingularityFountain.
 */

class SectorEtaSingularityFountainEvent {
  constructor(anomalyId = 'ano_sectoreta_14') {
...
module.exports = { SectorEtaSingularityFountainEvent };
