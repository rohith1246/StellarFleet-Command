/**
 * SectorEtaNeutronStarPulsarEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorEta -> NeutronStarPulsar.
 */

class SectorEtaNeutronStarPulsarEvent {
  constructor(anomalyId = 'ano_sectoreta_2') {
...
module.exports = { SectorEtaNeutronStarPulsarEvent };
