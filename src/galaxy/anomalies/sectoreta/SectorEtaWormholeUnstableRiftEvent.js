/**
 * SectorEtaWormholeUnstableRiftEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorEta -> WormholeUnstableRift.
 */

class SectorEtaWormholeUnstableRiftEvent {
  constructor(anomalyId = 'ano_sectoreta_1') {
...
module.exports = { SectorEtaWormholeUnstableRiftEvent };
