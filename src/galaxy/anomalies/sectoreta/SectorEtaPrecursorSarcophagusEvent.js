/**
 * SectorEtaPrecursorSarcophagusEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorEta -> PrecursorSarcophagus.
 */

class SectorEtaPrecursorSarcophagusEvent {
  constructor(anomalyId = 'ano_sectoreta_13') {
...
module.exports = { SectorEtaPrecursorSarcophagusEvent };
