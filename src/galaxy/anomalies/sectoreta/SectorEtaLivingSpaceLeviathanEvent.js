/**
 * SectorEtaLivingSpaceLeviathanEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorEta -> LivingSpaceLeviathan.
 */

class SectorEtaLivingSpaceLeviathanEvent {
  constructor(anomalyId = 'ano_sectoreta_7') {
...
module.exports = { SectorEtaLivingSpaceLeviathanEvent };
