/**
 * SectorEtaHyperlaneCollapseZoneEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorEta -> HyperlaneCollapseZone.
 */

class SectorEtaHyperlaneCollapseZoneEvent {
  constructor(anomalyId = 'ano_sectoreta_9') {
...
module.exports = { SectorEtaHyperlaneCollapseZoneEvent };
