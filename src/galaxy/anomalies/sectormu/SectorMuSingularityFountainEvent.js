/**
 * SectorMuSingularityFountainEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorMu -> SingularityFountain.
 */

class SectorMuSingularityFountainEvent {
  constructor(anomalyId = 'ano_sectormu_14') {
...
module.exports = { SectorMuSingularityFountainEvent };
