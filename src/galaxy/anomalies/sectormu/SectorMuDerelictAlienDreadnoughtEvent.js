/**
 * SectorMuDerelictAlienDreadnoughtEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorMu -> DerelictAlienDreadnought.
 */

class SectorMuDerelictAlienDreadnoughtEvent {
  constructor(anomalyId = 'ano_sectormu_0') {
...
module.exports = { SectorMuDerelictAlienDreadnoughtEvent };
