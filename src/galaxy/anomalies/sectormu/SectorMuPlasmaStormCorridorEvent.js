/**
 * SectorMuPlasmaStormCorridorEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorMu -> PlasmaStormCorridor.
 */

class SectorMuPlasmaStormCorridorEvent {
  constructor(anomalyId = 'ano_sectormu_12') {
...
module.exports = { SectorMuPlasmaStormCorridorEvent };
