/**
 * SectorMuWormholeUnstableRiftEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorMu -> WormholeUnstableRift.
 */

class SectorMuWormholeUnstableRiftEvent {
  constructor(anomalyId = 'ano_sectormu_1') {
...
module.exports = { SectorMuWormholeUnstableRiftEvent };
