/**
 * SectorMuHyperlaneCollapseZoneEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorMu -> HyperlaneCollapseZone.
 */

class SectorMuHyperlaneCollapseZoneEvent {
  constructor(anomalyId = 'ano_sectormu_9') {
...
module.exports = { SectorMuHyperlaneCollapseZoneEvent };
