/**
 * SectorEpsilonPrecursorSarcophagusEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorEpsilon -> PrecursorSarcophagus.
 */

class SectorEpsilonPrecursorSarcophagusEvent {
  constructor(anomalyId = 'ano_sectorepsilon_13') {
...
module.exports = { SectorEpsilonPrecursorSarcophagusEvent };
