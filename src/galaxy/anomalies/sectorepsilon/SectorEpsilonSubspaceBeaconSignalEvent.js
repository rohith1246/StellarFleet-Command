/**
 * SectorEpsilonSubspaceBeaconSignalEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorEpsilon -> SubspaceBeaconSignal.
 */

class SectorEpsilonSubspaceBeaconSignalEvent {
  constructor(anomalyId = 'ano_sectorepsilon_6') {
...
module.exports = { SectorEpsilonSubspaceBeaconSignalEvent };
