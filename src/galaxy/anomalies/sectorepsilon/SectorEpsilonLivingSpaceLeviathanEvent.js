/**
 * SectorEpsilonLivingSpaceLeviathanEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorEpsilon -> LivingSpaceLeviathan.
 */

class SectorEpsilonLivingSpaceLeviathanEvent {
  constructor(anomalyId = 'ano_sectorepsilon_7') {
...
module.exports = { SectorEpsilonLivingSpaceLeviathanEvent };
