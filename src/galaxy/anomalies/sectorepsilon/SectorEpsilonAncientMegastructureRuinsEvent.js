/**
 * SectorEpsilonAncientMegastructureRuinsEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorEpsilon -> AncientMegastructureRuins.
 */

class SectorEpsilonAncientMegastructureRuinsEvent {
  constructor(anomalyId = 'ano_sectorepsilon_3') {
    this.anomalyId = anomalyId;
    this.sector = 'SectorEpsilon';
    this.anomalyType = 'AncientMegastructureRuins';
    this.scanningDifficulty = 14;
    this.sciencePointsReward = 1050;
...
module.exports = { SectorEpsilonAncientMegastructureRuinsEvent };
