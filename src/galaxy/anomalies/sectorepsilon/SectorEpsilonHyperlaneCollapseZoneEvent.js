/**
 * SectorEpsilonHyperlaneCollapseZoneEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorEpsilon -> HyperlaneCollapseZone.
 */

class SectorEpsilonHyperlaneCollapseZoneEvent {
  constructor(anomalyId = 'ano_sectorepsilon_9') {
...
module.exports = { SectorEpsilonHyperlaneCollapseZoneEvent };
