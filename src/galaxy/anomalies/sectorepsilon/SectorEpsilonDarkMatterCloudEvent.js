/**
 * SectorEpsilonDarkMatterCloudEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorEpsilon -> DarkMatterCloud.
 */

class SectorEpsilonDarkMatterCloudEvent {
  constructor(anomalyId = 'ano_sectorepsilon_4') {
...
module.exports = { SectorEpsilonDarkMatterCloudEvent };
