/**
 * SectorEpsilonPlasmaStormCorridorEvent.js - Galaxy Sector Anomaly & Exploration Event Engine: SectorEpsilon -> PlasmaStormCorridor.
 */

class SectorEpsilonPlasmaStormCorridorEvent {
  constructor(anomalyId = 'ano_sectorepsilon_12') {
...
module.exports = { SectorEpsilonPlasmaStormCorridorEvent };
